...
var G__21804 = h;
G__21804.setUseFragment(false);

G__21804.setPathPrefix("");

G__21804.setEnabled(true);
...
(pushy.core.pushy.cljs$core$IFn$_invoke$arity$variadic = (function (dispatch_fn,match_fn,p__21828){
var map__21829 = p__21828;
var map__21829__$1 = cljs.core.__destructure_map(map__21829);
var processable_url_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21829__$1,new cljs.core.Keyword(null,"processable-url?","processable-url?",1865408336),pushy.core.processable_url_QMARK_);
var identity_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21829__$1,new cljs.core.Keyword(null,"identity-fn","identity-fn",-884182627),cljs.core.identity);
var prevent_default_when_no_match_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21829__$1,new cljs.core.Keyword(null,"prevent-default-when-no-match?","prevent-default-when-no-match?",-358623618),cljs.core.constantly(false));
...
*/
pushy.core.t_pushy$core21834 = (function (event_keys,identity_fn,prevent_default_when_no_match_QMARK_,dispatch_fn,p__21828,history,processable_url_QMARK_,map__21829,match_fn,meta21835){
this.event_keys = event_keys;
this.identity_fn = identity_fn;
this.prevent_default_when_no_match_QMARK_ = prevent_default_when_no_match_QMARK_;
this.dispatch_fn = dispatch_fn;
this.p__21828 = p__21828;
this.history = history;
this.processable_url_QMARK_ = processable_url_QMARK_;
this.map__21829 = map__21829;
...
var self__ = this;
var _21836__$1 = this;
return (new pushy.core.t_pushy$core21834(self__.event_keys,self__.identity_fn,self__.prevent_default_when_no_match_QMARK_,self__.dispatch_fn,self__.p__21828,self__.history,self__.processable_url_QMARK_,self__.map__21829,self__.match_fn,meta21835__$1));
}));
...
var temp__5753__auto__ = (function (){var G__21838 = (function (){var G__21840 = e.token;
return (self__.match_fn.cljs$core$IFn$_invoke$arity$1 ? self__.match_fn.cljs$core$IFn$_invoke$arity$1(G__21840) : self__.match_fn.call(null,G__21840));
})();
...
var temp__5753__auto___21888 = (function (){var G__21842 = (function (){var G__21843 = this$__$1.pushy$core$IHistory$get_token$arity$1(null);
...
if(cljs.core.truth_(temp__5753__auto___21888)){
var match_21891 = temp__5753__auto___21888;
(self__.dispatch_fn.cljs$core$IFn$_invoke$arity$1 ? self__.dispatch_fn.cljs$core$IFn$_invoke$arity$1(match_21891) : self__.dispatch_fn.call(null,match_21891));
} else {
}
...
var temp__5751__auto___21892 = el.title;
if(cljs.core.truth_(temp__5751__auto___21892)){
var title_21893 = temp__5751__auto___21892;
this$__$1.pushy$core$IHistory$set_token_BANG_$arity$3(null,next_token,title_21893);
} else {
...
var self__ = this;
var this$__$1 = this;
var seq__21846_21896 = cljs.core.seq(cljs.core.deref(self__.event_keys));
var chunk__21847_21897 = null;
var count__21848_21898 = (0);
var i__21849_21899 = (0);
while(true){
if((i__21849_21899 < count__21848_21898)){
var key_21900 = chunk__21847_21897.cljs$core$IIndexed$_nth$arity$2(null,i__21849_21899);
goog.events.unlistenByKey(key_21900);


var G__21901 = seq__21846_21896;
var G__21902 = chunk__21847_21897;
var G__21903 = count__21848_21898;
var G__21904 = (i__21849_21899 + (1));
seq__21846_21896 = G__21901;
chunk__21847_21897 = G__21902;
count__21848_21898 = G__21903;
i__21849_21899 = G__21904;
continue;
} else {
var temp__5753__auto___21905 = cljs.core.seq(seq__21846_21896);
if(temp__5753__auto___21905){
var seq__21846_21906__$1 = temp__5753__auto___21905;
if(cljs.core.chunked_seq_QMARK_(seq__21846_21906__$1)){
var c__4679__auto___21907 = cljs.core.chunk_first(seq__21846_21906__$1);
var G__21908 = cljs.core.chunk_rest(seq__21846_21906__$1);
var G__21909 = c__4679__auto___21907;
var G__21910 = cljs.core.count(c__4679__auto___21907);
var G__21911 = (0);
seq__21846_21896 = G__21908;
chunk__21847_21897 = G__21909;
count__21848_21898 = G__21910;
i__21849_21899 = G__21911;
continue;
} else {
var key_21912 = cljs.core.first(seq__21846_21906__$1);
goog.events.unlistenByKey(key_21912);


var G__21913 = cljs.core.next(seq__21846_21906__$1);
var G__21914 = null;
var G__21915 = (0);
var G__21916 = (0);
seq__21846_21896 = G__21913;
chunk__21847_21897 = G__21914;
count__21848_21898 = G__21915;
i__21849_21899 = G__21916;
continue;
}
} else {
}
...
return new cljs.core.PersistentVector(null, 10, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"event-keys","event-keys",804564896,null),new cljs.core.Symbol(null,"identity-fn","identity-fn",756348900,null),new cljs.core.Symbol(null,"prevent-default-when-no-match?","prevent-default-when-no-match?",1281907909,null),new cljs.core.Symbol(null,"dispatch-fn","dispatch-fn",-1401088155,null),new cljs.core.Symbol(null,"p__21828","p__21828",1489157575,null),new cljs.core.Symbol(null,"history","history",1393136307,null),new cljs.core.Symbol(null,"processable-url?","processable-url?",-789027433,null),new cljs.core.Symbol(null,"map__21829","map__21829",869195386,null),new cljs.core.Symbol(null,"match-fn","match-fn",-795226853,null),new cljs.core.Symbol(null,"meta21835","meta21835",-1846046907,null)], null);
}));
 ...
 */
pushy.core.__GT_t_pushy$core21834 = (function pushy$core$__GT_t_pushy$core21834(event_keys__$1,identity_fn__$1,prevent_default_when_no_match_QMARK___$1,dispatch_fn__$1,p__21828__$1,history__$1,processable_url_QMARK___$1,map__21829__$2,match_fn__$1,meta21835){
return (new pushy.core.t_pushy$core21834(event_keys__$1,identity_fn__$1,prevent_default_when_no_match_QMARK___$1,dispatch_fn__$1,p__21828__$1,history__$1,processable_url_QMARK___$1,map__21829__$2,match_fn__$1,meta21835));
});

}

return (new pushy.core.t_pushy$core21834(event_keys,identity_fn,prevent_default_when_no_match_QMARK_,dispatch_fn,p__21828,history,processable_url_QMARK_,map__21829__$1,match_fn,cljs.core.PersistentArrayMap.EMPTY));
}));

(pushy.core.pushy.cljs$lang$maxFixedArity = (2));

/** @this {Function} */
(pushy.core.pushy.cljs$lang$applyTo = (function (seq21825){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21826,G__21827,seq21825__$2);
}));
