...
Authentication.authentication.redirect_uri = "http://localhost:3000/auth";
Authentication.authentication.domain = "mnie-test.criipto.id";
...
var args = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"domain","domain",1847214937),Authentication.authentication.domain,new cljs.core.Keyword(null,"clientID","clientID",-1997444035),Authentication.authentication.client_id,new cljs.core.Keyword(null,"store","store",1512230022),session_storage], null));
...
var temp__5753__auto__ = (function (){var G__21753 = result;
if((G__21753 == null)){
return null;
} else {
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(G__21753);
}
})();
...
var args = cljs.core.clj__GT_js(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"redirectUri","redirectUri",-530835168),Authentication.authentication.redirect_uri,new cljs.core.Keyword(null,"acrValues","acrValues",411239607),Authentication.authentication.acr_mitid], null));
return Authentication.authentication.authenticator.redirect.authorize(args);
});
Authentication.authentication.json_string__GT_clj = cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__21754_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__21754_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
}),(function (p1__21755_SHARP_){
return JSON.parse(p1__21755_SHARP_);
}));
...
var vec__21756 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(id_token,/\./);
var header_base64 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21756,(0),null);
var payload_base64 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21756,(1),null);
var signature = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21756,(2),null);
...
Authentication.authentication.js_storage_key_for_auth = ["oidc.user:",Authentication.authentication.domain,":",Authentication.authentication.client_id].join('');
...
var _db = map__21760__$1;
var authorization_result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21760__$1,new cljs.core.Keyword(null,"authorization-result","authorization-result",1368017039));
