...
var temp__5753__auto__ = (function (){var G__21755 = result;
if((G__21755 == null)){
return null;
} else {
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(G__21755);
}
})();
...
Authentication.authentication.json_string__GT_clj = cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__21756_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__21756_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
}),(function (p1__21757_SHARP_){
return JSON.parse(p1__21757_SHARP_);
}));
...
var vec__21758 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(id_token,/\./);
var header_base64 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21758,(0),null);
var payload_base64 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21758,(1),null);
var signature = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21758,(2),null);
...
Authentication.authentication.clear_url_params_BANG_ = (function Authentication$authentication$clear_url_params_BANG_(){
return window.history.replaceState(cljs.core.clj__GT_js(cljs.core.PersistentArrayMap.EMPTY),document.title,location.pathname);
});
...
return (function (p__21761){
var map__21764 = p__21761;
var map__21764__$1 = cljs.core.__destructure_map(map__21764);
var _db = map__21764__$1;
var authorization_result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21764__$1,new cljs.core.Keyword(null,"authorization-result","authorization-result",1368017039));
Authentication.authentication.clear_url_params_BANG_();
