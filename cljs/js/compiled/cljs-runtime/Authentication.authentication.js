...
return ["http://",cljs.core.str.cljs$core$IFn$_invoke$arity$1(window.location.host),"/auth"].join('');
} else {
return ["https://",cljs.core.str.cljs$core$IFn$_invoke$arity$1(window.location.host),"/samples/cljs/auth"].join('');
}
}),null));
...
Authentication.authentication.json_string__GT_clj = cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__21778_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__21778_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
}),(function (p1__21779_SHARP_){
return JSON.parse(p1__21779_SHARP_);
}));
...
var vec__21784 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(id_token,/\./);
var header_base64 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21784,(0),null);
var payload_base64 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21784,(1),null);
var signature = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21784,(2),null);
...
return (function (p__21792){
var map__21802 = p__21792;
var map__21802__$1 = cljs.core.__destructure_map(map__21802);
var _db = map__21802__$1;
var authorization_result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21802__$1,new cljs.core.Keyword(null,"authorization-result","authorization-result",1368017039));
