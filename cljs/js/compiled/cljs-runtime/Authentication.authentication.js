...
var temp__5753__auto__ = (function (){var G__21767 = result;
if((G__21767 == null)){
return null;
} else {
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(G__21767);
}
})();
...
Authentication.authentication.json_string__GT_clj = cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__21770_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$variadic(p1__21770_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"keywordize-keys","keywordize-keys",1310784252),true], 0));
}),(function (p1__21771_SHARP_){
return JSON.parse(p1__21771_SHARP_);
}));
...
var vec__21775 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(id_token,/\./);
var header_base64 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21775,(0),null);
var payload_base64 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21775,(1),null);
var signature = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21775,(2),null);
...
var _db = map__21785__$1;
var authorization_result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21785__$1,new cljs.core.Keyword(null,"authorization-result","authorization-result",1368017039));
