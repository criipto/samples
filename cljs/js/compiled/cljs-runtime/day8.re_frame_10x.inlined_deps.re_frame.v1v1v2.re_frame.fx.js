...
var _STAR_current_trace_STAR__orig_val__15355 = day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace._STAR_current_trace_STAR_;
var _STAR_current_trace_STAR__temp_val__15356 = day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace.start_trace(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"op-type","op-type",-1636141668),new cljs.core.Keyword("event","do-fx","event/do-fx",1357330452)], null));
(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__temp_val__15356);
...
var fexpr__15357_15453 = day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.registrar.get_handler.cljs$core$IFn$_invoke$arity$3(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.fx.kind,new cljs.core.Keyword(null,"db","db",993250759),false);
(fexpr__15357_15453.cljs$core$IFn$_invoke$arity$1 ? fexpr__15357_15453.cljs$core$IFn$_invoke$arity$1(new_db_15452) : fexpr__15357_15453.call(null,new_db_15452));
} else {
}

var seq__15358 = cljs.core.seq(effects_without_db);
var chunk__15359 = null;
var count__15360 = (0);
var i__15361 = (0);
while(true){
if((i__15361 < count__15360)){
var vec__15368 = chunk__15359.cljs$core$IIndexed$_nth$arity$2(null,i__15361);
var effect_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15368,(0),null);
var effect_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15368,(1),null);
...
var G__15456 = seq__15358;
var G__15457 = chunk__15359;
var G__15458 = count__15360;
var G__15459 = (i__15361 + (1));
seq__15358 = G__15456;
chunk__15359 = G__15457;
count__15360 = G__15458;
i__15361 = G__15459;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__15358);
if(temp__5753__auto__){
var seq__15358__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__15358__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__15358__$1);
var G__15460 = cljs.core.chunk_rest(seq__15358__$1);
var G__15461 = c__4679__auto__;
var G__15462 = cljs.core.count(c__4679__auto__);
var G__15463 = (0);
seq__15358 = G__15460;
chunk__15359 = G__15461;
count__15360 = G__15462;
i__15361 = G__15463;
continue;
} else {
var vec__15371 = cljs.core.first(seq__15358__$1);
var effect_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15371,(0),null);
var effect_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15371,(1),null);
...
var G__15466 = cljs.core.next(seq__15358__$1);
var G__15467 = null;
var G__15468 = (0);
var G__15469 = (0);
seq__15358 = G__15466;
chunk__15359 = G__15467;
count__15360 = G__15468;
i__15361 = G__15469;
continue;
}
} else {
...
}}finally {(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__orig_val__15355);
}} else {
...
var fexpr__15374_15474 = day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.registrar.get_handler.cljs$core$IFn$_invoke$arity$3(day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.fx.kind,new cljs.core.Keyword(null,"db","db",993250759),false);
(fexpr__15374_15474.cljs$core$IFn$_invoke$arity$1 ? fexpr__15374_15474.cljs$core$IFn$_invoke$arity$1(new_db_15473) : fexpr__15374_15474.call(null,new_db_15473));
} else {
}

var seq__15375 = cljs.core.seq(effects_without_db);
var chunk__15376 = null;
var count__15377 = (0);
var i__15378 = (0);
while(true){
if((i__15378 < count__15377)){
var vec__15395 = chunk__15376.cljs$core$IIndexed$_nth$arity$2(null,i__15378);
var effect_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15395,(0),null);
var effect_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15395,(1),null);
...
var G__15477 = seq__15375;
var G__15478 = chunk__15376;
var G__15479 = count__15377;
var G__15480 = (i__15378 + (1));
seq__15375 = G__15477;
chunk__15376 = G__15478;
count__15377 = G__15479;
i__15378 = G__15480;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__15375);
if(temp__5753__auto__){
var seq__15375__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__15375__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__15375__$1);
var G__15481 = cljs.core.chunk_rest(seq__15375__$1);
var G__15482 = c__4679__auto__;
var G__15483 = cljs.core.count(c__4679__auto__);
var G__15484 = (0);
seq__15375 = G__15481;
chunk__15376 = G__15482;
count__15377 = G__15483;
i__15378 = G__15484;
continue;
} else {
var vec__15398 = cljs.core.first(seq__15375__$1);
...
var G__15487 = cljs.core.next(seq__15375__$1);
var G__15488 = null;
var G__15489 = (0);
var G__15490 = (0);
seq__15375 = G__15487;
chunk__15376 = G__15488;
count__15377 = G__15489;
i__15378 = G__15490;
continue;
}
} else {
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.fx.dispatch_later = (function day8$re_frame_10x$inlined_deps$re_frame$v1v1v2$re_frame$fx$dispatch_later(p__15401){
var map__15402 = p__15401;
var map__15402__$1 = cljs.core.__destructure_map(map__15402);
var effect = map__15402__$1;
var ms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15402__$1,new cljs.core.Keyword(null,"ms","ms",-1152709733));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__15402__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
...
var vec__15429 = chunk__15412.cljs$core$IIndexed$_nth$arity$2(null,i__15414);
var effect_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15429,(0),null);
var effect_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15429,(1),null);
...
var vec__15432 = cljs.core.first(seq__15411__$1);
var effect_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15432,(0),null);
var effect_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__15432,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"db","db",993250759),effect_key)){
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"warn","warn",-436710552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: \":fx\" effect should not contain a :db effect"], 0));
} else {
}
...
var seq__15435 = cljs.core.seq(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,value));
var chunk__15436 = null;
var count__15437 = (0);
var i__15438 = (0);
while(true){
if((i__15438 < count__15437)){
var event = chunk__15436.cljs$core$IIndexed$_nth$arity$2(null,i__15438);
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.router.dispatch(event);


var G__15519 = seq__15435;
var G__15520 = chunk__15436;
var G__15521 = count__15437;
var G__15522 = (i__15438 + (1));
seq__15435 = G__15519;
chunk__15436 = G__15520;
count__15437 = G__15521;
i__15438 = G__15522;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__15435);
if(temp__5753__auto__){
var seq__15435__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__15435__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__15435__$1);
var G__15523 = cljs.core.chunk_rest(seq__15435__$1);
var G__15524 = c__4679__auto__;
var G__15525 = cljs.core.count(c__4679__auto__);
var G__15526 = (0);
seq__15435 = G__15523;
chunk__15436 = G__15524;
count__15437 = G__15525;
i__15438 = G__15526;
continue;
} else {
var event = cljs.core.first(seq__15435__$1);
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.router.dispatch(event);


var G__15527 = cljs.core.next(seq__15435__$1);
var G__15528 = null;
var G__15529 = (0);
var G__15530 = (0);
seq__15435 = G__15527;
chunk__15436 = G__15528;
count__15437 = G__15529;
i__15438 = G__15530;
continue;
}
} else {
