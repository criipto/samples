...
var G__18199 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__18199__$1 = (((G__18199 == null))?null:cljs.core.iterate((function (loc){
...
var G__18199__$2 = (((G__18199__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__18199__$1));
var G__18199__$3 = (((G__18199__$2 == null))?null:cljs.core.last(G__18199__$2));
if((G__18199__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__18199__$3);
}
} else {
return zloc;
}
...
var G__18204 = rewrite_clj.zip.move.right(v);
var G__18205 = rewrite_clj.zip.move.up(v);
loc = G__18204;
parent = G__18205;
continue;
} else {
var G__18206 = rewrite_clj.zip.move.right(v0);
var G__18207 = parent;
loc = G__18206;
parent = G__18207;
continue;
...
var G__18208 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__18209 = rewrite_clj.zip.move.up(v);
loc = G__18208;
parent = G__18209;
continue;
} else {
var G__18210 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__18211 = parent;
loc = G__18210;
parent = G__18211;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__18202 = zloc;
var G__18202__$1 = (((G__18202 == null))?null:rewrite_clj.zip.move.down(G__18202));
var G__18202__$2 = (((G__18202__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__18202__$1,k));
if((G__18202__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__18202__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__18203 = rewrite_clj.zip.move.down(zloc);
var G__18203__$1 = (((G__18203 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__18203));
if((G__18203__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__18203__$1);
}
})(),k);
}
});
