...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__15965 = c;
var G__15965__$1 = (((G__15965 == null))?null:G__15965.prototype);
if((G__15965__$1 == null)){
return null;
} else {
return G__15965__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__15966 = c;
var G__15966__$1 = (((G__15966 == null))?null:G__15966.prototype);
if((G__15966__$1 == null)){
return null;
} else {
return G__15966__$1.render;
}
})() == null)))));
});
...
var _STAR_current_component_STAR__orig_val__16011 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__16012 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__16012);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__16011);
}});
...
var c = this;
var G__16044_16062 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__16044_16062 == null)){
} else {
reagent.ratom.dispose_BANG_(G__16044_16062);
}
...
var renders_16064 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_16065 = cljs.core.first(cljs.core.vals(renders_16064));
...
if((cljs.core.count(renders_16064) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_16064))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_16065)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_16065], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
return (function() { 
var G__16066__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
var G__16066 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__16067__i = 0, G__16067__a = new Array(arguments.length -  0);
while (G__16067__i < G__16067__a.length) {G__16067__a[G__16067__i] = arguments[G__16067__i + 0]; ++G__16067__i;}
  args = new cljs.core.IndexedSeq(G__16067__a,0,null);
} 
return G__16066__delegate.call(this,args);};
G__16066.cljs$lang$maxFixedArity = 0;
G__16066.cljs$lang$applyTo = (function (arglist__16068){
var args = cljs.core.seq(arglist__16068);
return G__16066__delegate(args);
});
