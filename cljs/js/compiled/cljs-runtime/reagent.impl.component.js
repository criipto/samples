...
while (G__16030__i < G__16030__a.length) {G__16030__a[G__16030__i] = arguments[G__16030__i + 0]; ++G__16030__i;}
  args = new cljs.core.IndexedSeq(G__16030__a,0,null);
} 
...
var c = this;
var G__15973_16047 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__15973_16047 == null)){
} else {
reagent.ratom.dispose_BANG_(G__15973_16047);
}
...
var renders_16050 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_16051 = cljs.core.first(cljs.core.vals(renders_16050));
...
if((cljs.core.count(renders_16050) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_16050))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_16051)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_16051], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__15975 = o;
reagent.impl.component.goog$module$goog$object.set(G__15975,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__16000 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__16001 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__16001);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__16000);
}});
...
var vec__16002 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16002,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16002,(1),null);
...
var G__16005 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__16005 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__16005);
}
});
}),[]);
