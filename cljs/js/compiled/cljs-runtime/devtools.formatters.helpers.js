...
var G__11260 = devtools.prefs.pref(v);
v = G__11260;
continue;
} else {
return v;
...
}catch (e11240){var _e__8645__auto__ = e11240;
return false;
}})();
...
}catch (e11242){var _e__8645__auto__ = e11242;
return false;
}})();
...
}catch (e11245){var _e__8645__auto__ = e11245;
return false;
}}
}
});
...
var vec__11255 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11255,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11255,(1),null);
...
return cljs.core.some((function (p1__11258_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11258_SHARP_);
}),template);
});
