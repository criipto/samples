...
var G__11258 = devtools.prefs.pref(v);
v = G__11258;
continue;
} else {
return v;
...
}catch (e11228){var _e__8563__auto__ = e11228;
return false;
}})();
...
}catch (e11230){var _e__8563__auto__ = e11230;
return false;
}})();
...
}catch (e11232){var _e__8563__auto__ = e11232;
return false;
}}
}
});
...
var vec__11247 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11247,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11247,(1),null);
...
return cljs.core.some((function (p1__11250_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11250_SHARP_);
}),template);
});
