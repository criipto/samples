...
var G__19910 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,i_s);
var G__19911 = (i_s + (1));
var G__19912 = (i_s_SINGLEQUOTE_ + (1));
v = G__19910;
i_s = G__19911;
i_s_SINGLEQUOTE_ = G__19912;
continue;
} else {
var G__19913 = v;
var G__19914 = (i_s + (1));
var G__19915 = i_s_SINGLEQUOTE_;
v = G__19913;
i_s = G__19914;
i_s_SINGLEQUOTE_ = G__19915;
continue;
...
var vec__19883 = result;
var vec__19886 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19883,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19886,(0),null);
var pre_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19886,(1),null);
var matched_form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19886,(2),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19883,(1),null);
...
var start = (function (){var G__19889 = form_str__$1;
var G__19889__$1 = (((G__19889 == null))?null:clojure.string.index_of.cljs$core$IFn$_invoke$arity$2(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([search_str], 0)),G__19889));
if((G__19889__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__19889__$1);
}
})();
...
var end = (function (){var G__19890 = start;
var G__19890__$1 = (((G__19890 == null))?null:(length + G__19890));
if((G__19890__$1 == null)){
return null;
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2(reindex,G__19890__$1);
}
})();
...
var vec__19891 = day8.re_frame_10x.view.event.find_bounds(form_str,new cljs.core.Keyword(null,"form","form",-1624062471).cljs$core$IFn$_invoke$arity$1(highlighted_form),new cljs.core.Keyword(null,"num-seen","num-seen",-1576518431).cljs$core$IFn$_invoke$arity$1(highlighted_form));
var start_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19891,(0),null);
var end_index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19891,(1),null);
...
return null;
});})(i__19900,id,first_QMARK_,frag,c__4650__auto__,size__4651__auto__,b__19901,s__19899__$2,temp__5753__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments))
,new cljs.core.Keyword(null,"on-mouse-leave","on-mouse-leave",-1864319528),((function (i__19900,id,first_QMARK_,frag,c__4650__auto__,size__4651__auto__,b__19901,s__19899__$2,temp__5753__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__19901),day8$re_frame_10x$view$event$event_fragments_$_iter__19898(cljs.core.chunk_rest(s__19899__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__19901),null);
}
} else {
var frag = cljs.core.first(s__19899__$2);
return cljs.core.cons((function (){var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(frag);
var first_QMARK_ = (id === (0));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"class","class",-2030961996),"code-fragment",new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-top","margin-top",392161226),((first_QMARK_)?null:"-1px")], null),new cljs.core.Keyword(null,"attr","attr",-604132353),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-mouse-enter","on-mouse-enter",-1664921661),((function (id,first_QMARK_,frag,s__19899__$2,temp__5753__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","hover-form","code/hover-form",1557522458),frag], null));

return null;
});})(id,first_QMARK_,frag,s__19899__$2,temp__5753__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments))
,new cljs.core.Keyword(null,"on-mouse-leave","on-mouse-leave",-1864319528),((function (id,first_QMARK_,frag,s__19899__$2,temp__5753__auto__,code_open_QMARK_,max_frags,execution_order_QMARK_,fragments){
return (function (event){
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("code","exit-hover-form","code/exit-hover-form",-202062797),frag], null));
...
})(),day8$re_frame_10x$view$event$event_fragments_$_iter__19898(cljs.core.rest(s__19899__$2)));
}
} else {
return null;
}
