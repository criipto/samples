...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__21644){
var map__21645 = p__21644;
var map__21645__$1 = cljs.core.__destructure_map(map__21645);
var request = map__21645__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21645__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__21648 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__21648.cljs$core$IFn$_invoke$arity$1 ? fexpr__21648.cljs$core$IFn$_invoke$arity$1(response) : fexpr__21648.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__21649 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__21649.cljs$core$IFn$_invoke$arity$1 ? fexpr__21649.cljs$core$IFn$_invoke$arity$1(response) : fexpr__21649.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__21650){
var map__21651 = p__21650;
var map__21651__$1 = cljs.core.__destructure_map(map__21651);
var request = map__21651__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21651__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
