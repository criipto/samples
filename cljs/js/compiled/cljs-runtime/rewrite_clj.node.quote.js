...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k17675,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k17675,else__4505__auto__);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__17674){
var self__ = this;
var G__17674__$1 = this;
return (new cljs.core.RecordIter((0),G__17674__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this17676,other17677){
var self__ = this;
var this17676__$1 = this;
return (((!((other17677 == null)))) && ((((this17676__$1.constructor === other17677.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17676__$1.tag,other17677.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17676__$1.prefix,other17677.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17676__$1.sym,other17677.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17676__$1.children,other17677.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17676__$1.__extmap,other17677.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k17675){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k17675);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__17674){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__17691 = cljs.core.keyword_identical_QMARK_;
var expr__17692 = k__4511__auto__;
if(cljs.core.truth_((pred__17691.cljs$core$IFn$_invoke$arity$2 ? pred__17691.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__17692) : pred__17691.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__17692)))){
return (new rewrite_clj.node.quote.QuoteNode(G__17674,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17691.cljs$core$IFn$_invoke$arity$2 ? pred__17691.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__17692) : pred__17691.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__17692)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__17674,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17691.cljs$core$IFn$_invoke$arity$2 ? pred__17691.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__17692) : pred__17691.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__17692)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__17674,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17691.cljs$core$IFn$_invoke$arity$2 ? pred__17691.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__17692) : pred__17691.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__17692)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__17674,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__17674),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__17674){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__17674,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__17678){
var extmap__4542__auto__ = (function (){var G__17701 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__17678,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__17678)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__17701);
} else {
return G__17701;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__17678),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__17678),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__17678),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__17678),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
