...
var G__16549 = cljs.core.next(ssv);
var G__16550 = (this_ssv == null);
var G__16551 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__16552 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__16549;
doing_nil_QMARK_ = G__16550;
last_elide = G__16551;
out = G__16552;
continue;
}
...
var vec__16480 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16480,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16480,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16480,(2),null);
...
var G__16553 = cljs.core.next(remaining_cvec);
var G__16554 = new_idx;
var G__16555 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__16553;
idx = G__16554;
out = G__16555;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__16496,cursor_vec){
var vec__16497 = p__16496;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16497,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16497,(1),null);
var focus_vec = vec__16497;
...
var vec__16500 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16500,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16500,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__16504){
var vec__16505 = p__16504;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16505,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16505,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__16515,existing_count){
var vec__16517 = p__16515;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16517,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16517,(1),null);
...
return cljs.core.filterv((function (p1__16511_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__16511_SHARP_))));
...
var vec__16528 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16528,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16528,(1),null);
var cvec_element = vec__16528;
if((cvec_element == null)){
var G__16565 = cljs.core.next(cvec_nl);
var G__16566 = (idx + (1));
var G__16567 = start;
var G__16568 = out;
cvec_nl = G__16565;
...
var G__16569 = cljs.core.next(cvec_nl);
var G__16570 = (idx + (1));
var G__16571 = idx;
var G__16572 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__16569;
idx = G__16570;
start = G__16571;
out = G__16572;
...
var G__16573 = cljs.core.next(cvec_nl);
var G__16574 = (idx + (1));
var G__16575 = (idx + (1));
var G__16576 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__16573;
idx = G__16574;
start = G__16575;
out = G__16576;
...
var G__16577 = cljs.core.next(cvec_nl);
var G__16578 = (idx + (1));
var G__16579 = idx;
var G__16580 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__16577;
idx = G__16578;
start = G__16579;
out = G__16580;
...
var G__16581 = cljs.core.next(cvec_nl);
var G__16582 = (idx + (1));
var G__16583 = start;
var G__16584 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__16581;
idx = G__16582;
start = G__16583;
out = G__16584;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__16532_SHARP_,p2__16531_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__16531_SHARP_)){
return cljs.core.reduced(p1__16532_SHARP_);
} else {
return (p1__16532_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__16533,p__16534){
var vec__16535 = p__16533;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16535,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16535,(1),null);
var vec__16538 = p__16534;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16538,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16538,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__16543,cvec,focus_vec){
var map__16544 = p__16543;
var map__16544__$1 = cljs.core.__destructure_map(map__16544);
var options = map__16544__$1;
var map__16545 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16544__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__16545__$1 = cljs.core.__destructure_map(map__16545);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16545__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16545__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16545__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16542_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__16542_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
