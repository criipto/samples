...
var G__16554 = cljs.core.next(ssv);
var G__16555 = (this_ssv == null);
var G__16556 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__16557 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__16554;
doing_nil_QMARK_ = G__16555;
last_elide = G__16556;
out = G__16557;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__16494,cursor_vec){
var vec__16495 = p__16494;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16495,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16495,(1),null);
var focus_vec = vec__16495;
...
var vec__16498 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16498,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16498,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__16501){
var vec__16502 = p__16501;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16502,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16502,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__16510,existing_count){
var vec__16511 = p__16510;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16511,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16511,(1),null);
...
var vec__16524 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16524,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16524,(1),null);
var cvec_element = vec__16524;
if((cvec_element == null)){
var G__16576 = cljs.core.next(cvec_nl);
var G__16577 = (idx + (1));
var G__16578 = start;
var G__16579 = out;
cvec_nl = G__16576;
...
var G__16580 = cljs.core.next(cvec_nl);
var G__16581 = (idx + (1));
var G__16582 = idx;
var G__16583 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__16580;
idx = G__16581;
start = G__16582;
out = G__16583;
...
var G__16585 = (idx + (1));
var G__16586 = (idx + (1));
var G__16587 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__16584;
idx = G__16585;
start = G__16586;
out = G__16587;
...
var G__16589 = (idx + (1));
var G__16590 = idx;
var G__16591 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__16588;
idx = G__16589;
start = G__16590;
out = G__16591;
...
var G__16592 = cljs.core.next(cvec_nl);
var G__16593 = (idx + (1));
var G__16594 = start;
var G__16595 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__16592;
idx = G__16593;
start = G__16594;
out = G__16595;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__16529_SHARP_,p2__16528_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__16528_SHARP_)){
return cljs.core.reduced(p1__16529_SHARP_);
} else {
return (p1__16529_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__16531,p__16532){
var vec__16533 = p__16531;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16533,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16533,(1),null);
var vec__16536 = p__16532;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16536,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16536,(1),null);
