...
var G__16525 = cljs.core.next(ssv);
var G__16526 = (this_ssv == null);
var G__16527 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__16528 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__16525;
doing_nil_QMARK_ = G__16526;
last_elide = G__16527;
out = G__16528;
continue;
}
...
var G__16536 = cljs.core.next(remaining_cvec);
var G__16537 = new_idx;
var G__16538 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__16536;
idx = G__16537;
out = G__16538;
continue;
}
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__16501,existing_count){
var vec__16502 = p__16501;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16502,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16502,(1),null);
...
return cljs.core.filterv((function (p1__16498_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__16498_SHARP_))));
...
var vec__16508 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16508,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16508,(1),null);
var cvec_element = vec__16508;
...
var G__16568 = cljs.core.next(cvec_nl);
var G__16569 = (idx + (1));
var G__16570 = start;
var G__16571 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__16568;
idx = G__16569;
start = G__16570;
out = G__16571;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__16512_SHARP_,p2__16511_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__16511_SHARP_)){
return cljs.core.reduced(p1__16512_SHARP_);
} else {
return (p1__16512_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__16513,p__16514){
var vec__16515 = p__16513;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16515,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16515,(1),null);
var vec__16518 = p__16514;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16518,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16518,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__16522,cvec,focus_vec){
var map__16523 = p__16522;
var map__16523__$1 = cljs.core.__destructure_map(map__16523);
var options = map__16523__$1;
var map__16524 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16523__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__16524__$1 = cljs.core.__destructure_map(map__16524);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16524__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16524__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16524__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16521_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__16521_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
