...
var G__16538 = cljs.core.next(ssv);
var G__16539 = (this_ssv == null);
var G__16540 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__16541 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__16538;
doing_nil_QMARK_ = G__16539;
last_elide = G__16540;
out = G__16541;
continue;
}
...
var vec__16481 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16481,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16481,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16481,(2),null);
...
var G__16542 = cljs.core.next(remaining_cvec);
var G__16543 = new_idx;
var G__16544 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__16542;
idx = G__16543;
out = G__16544;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__16495,cursor_vec){
var vec__16496 = p__16495;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16496,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16496,(1),null);
var focus_vec = vec__16496;
...
var vec__16499 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16499,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16499,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__16502){
var vec__16503 = p__16502;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16503,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16503,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__16509,existing_count){
var vec__16510 = p__16509;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16510,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16510,(1),null);
...
return cljs.core.filterv((function (p1__16506_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__16506_SHARP_))));
...
var vec__16518 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16518,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16518,(1),null);
var cvec_element = vec__16518;
if((cvec_element == null)){
var G__16553 = cljs.core.next(cvec_nl);
var G__16554 = (idx + (1));
var G__16555 = start;
var G__16556 = out;
cvec_nl = G__16553;
...
var G__16557 = cljs.core.next(cvec_nl);
var G__16558 = (idx + (1));
var G__16559 = idx;
var G__16560 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__16557;
idx = G__16558;
start = G__16559;
out = G__16560;
...
var G__16561 = cljs.core.next(cvec_nl);
var G__16562 = (idx + (1));
var G__16563 = (idx + (1));
var G__16564 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__16561;
idx = G__16562;
start = G__16563;
out = G__16564;
...
var G__16566 = cljs.core.next(cvec_nl);
var G__16567 = (idx + (1));
var G__16568 = idx;
var G__16569 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__16566;
idx = G__16567;
start = G__16568;
out = G__16569;
...
var G__16570 = cljs.core.next(cvec_nl);
var G__16571 = (idx + (1));
var G__16572 = start;
var G__16573 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__16570;
idx = G__16571;
start = G__16572;
out = G__16573;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__16523_SHARP_,p2__16522_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__16522_SHARP_)){
return cljs.core.reduced(p1__16523_SHARP_);
} else {
return (p1__16523_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__16525,p__16526){
var vec__16527 = p__16525;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16527,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16527,(1),null);
var vec__16530 = p__16526;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16530,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16530,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__16535,cvec,focus_vec){
var map__16536 = p__16535;
var map__16536__$1 = cljs.core.__destructure_map(map__16536);
var options = map__16536__$1;
var map__16537 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16536__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__16537__$1 = cljs.core.__destructure_map(map__16537);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16537__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16537__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16537__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16534_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__16534_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
