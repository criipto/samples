...
var G__16565 = cljs.core.next(ss_vec);
...
var G__16567 = (pos + cljs.core.count(cljs.core.first(ss)));
var G__16568 = ((((same_style_QMARK_) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(initial_pos,pos))))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.add_length(current)));
ss_vec = G__16565;
current = G__16566;
pos = G__16567;
out = G__16568;
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__16493,cursor_vec){
var vec__16494 = p__16493;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16494,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16494,(1),null);
var focus_vec = vec__16494;
...
var vec__16497 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16497,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16497,(1),null);
...
var vec__16526 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16526,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16526,(1),null);
var cvec_element = vec__16526;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__16531_SHARP_,p2__16530_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__16530_SHARP_)){
return cljs.core.reduced(p1__16531_SHARP_);
} else {
return (p1__16531_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__16532,p__16533){
var vec__16535 = p__16532;
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16544_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__16544_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
