...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k17612,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k17612,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__17618){
var vec__17619 = p__17618;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17619,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17619,(1),null);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__17611){
var self__ = this;
var G__17611__$1 = this;
return (new cljs.core.RecordIter((0),G__17611__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this17613,other17614){
var self__ = this;
var this17613__$1 = this;
return (((!((other17614 == null)))) && ((((this17613__$1.constructor === other17614.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17613__$1.s,other17614.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17613__$1.__extmap,other17614.__extmap)))))));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k17612){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k17612);

}
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__17611){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__17623 = cljs.core.keyword_identical_QMARK_;
var expr__17624 = k__4511__auto__;
if(cljs.core.truth_((pred__17623.cljs$core$IFn$_invoke$arity$2 ? pred__17623.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"s","s",1705939918),expr__17624) : pred__17623.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__17624)))){
return (new rewrite_clj.node.comment.CommentNode(G__17611,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__17611),null));
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__17611){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.s,G__17611,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__17616){
var extmap__4542__auto__ = (function (){var G__17626 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__17616,new cljs.core.Keyword(null,"s","s",1705939918));
if(cljs.core.record_QMARK_(G__17616)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__17626);
} else {
return G__17626;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__17616),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
