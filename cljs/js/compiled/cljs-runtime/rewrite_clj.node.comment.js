...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k17603,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k17603,else__4505__auto__);
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__17602){
var self__ = this;
var G__17602__$1 = this;
return (new cljs.core.RecordIter((0),G__17602__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"s","s",1705939918)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this17604,other17605){
var self__ = this;
var this17604__$1 = this;
return (((!((other17605 == null)))) && ((((this17604__$1.constructor === other17605.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17604__$1.s,other17605.s)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17604__$1.__extmap,other17605.__extmap)))))));
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k17603){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k17603);

}
}));

(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__17602){
var self__ = this;
...
return (new rewrite_clj.node.comment.CommentNode(G__17602,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.comment.CommentNode(self__.s,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__17602),null));
}
}));
...
(rewrite_clj.node.comment.CommentNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__17602){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.comment.CommentNode(self__.s,G__17602,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.comment.map__GT_CommentNode = (function rewrite_clj$node$comment$map__GT_CommentNode(G__17606){
var extmap__4542__auto__ = (function (){var G__17642 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__17606,new cljs.core.Keyword(null,"s","s",1705939918));
if(cljs.core.record_QMARK_(G__17606)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__17642);
} else {
return G__17642;
}
})();
return (new rewrite_clj.node.comment.CommentNode(new cljs.core.Keyword(null,"s","s",1705939918).cljs$core$IFn$_invoke$arity$1(G__17606),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
