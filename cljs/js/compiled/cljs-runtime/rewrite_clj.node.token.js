...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k17900,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k17900,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__17905){
var vec__17906 = p__17905;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17906,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17906,(1),null);
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__17899){
var self__ = this;
var G__17899__$1 = this;
return (new cljs.core.RecordIter((0),G__17899__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"value","value",305978217),new cljs.core.Keyword(null,"string-value","string-value",1109600561)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this17901,other17902){
var self__ = this;
var this17901__$1 = this;
return (((!((other17902 == null)))) && ((((this17901__$1.constructor === other17902.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17901__$1.value,other17902.value)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17901__$1.string_value,other17902.string_value)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17901__$1.__extmap,other17902.__extmap)))))))));
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k17900){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k17900);

}
}));

(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__17899){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__17915 = cljs.core.keyword_identical_QMARK_;
var expr__17916 = k__4511__auto__;
if(cljs.core.truth_((pred__17915.cljs$core$IFn$_invoke$arity$2 ? pred__17915.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"value","value",305978217),expr__17916) : pred__17915.call(null,new cljs.core.Keyword(null,"value","value",305978217),expr__17916)))){
return (new rewrite_clj.node.token.TokenNode(G__17899,self__.string_value,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17915.cljs$core$IFn$_invoke$arity$2 ? pred__17915.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__17916) : pred__17915.call(null,new cljs.core.Keyword(null,"string-value","string-value",1109600561),expr__17916)))){
return (new rewrite_clj.node.token.TokenNode(self__.value,G__17899,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__17899),null));
}
}
}));
...
(rewrite_clj.node.token.TokenNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__17899){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.token.TokenNode(self__.value,self__.string_value,G__17899,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.token.map__GT_TokenNode = (function rewrite_clj$node$token$map__GT_TokenNode(G__17903){
var extmap__4542__auto__ = (function (){var G__17921 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__17903,new cljs.core.Keyword(null,"value","value",305978217),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string-value","string-value",1109600561)], 0));
if(cljs.core.record_QMARK_(G__17903)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__17921);
} else {
return G__17921;
}
})();
return (new rewrite_clj.node.token.TokenNode(new cljs.core.Keyword(null,"value","value",305978217).cljs$core$IFn$_invoke$arity$1(G__17903),new cljs.core.Keyword(null,"string-value","string-value",1109600561).cljs$core$IFn$_invoke$arity$1(G__17903),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
