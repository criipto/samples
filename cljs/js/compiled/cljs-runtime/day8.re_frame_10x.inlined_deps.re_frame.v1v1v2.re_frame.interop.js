...
return [(function (){var pred__14560 = cljs.core.instance_QMARK_;
var expr__14561 = reactive_val;
if(cljs.core.truth_((pred__14560.cljs$core$IFn$_invoke$arity$2 ? pred__14560.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__14561) : pred__14560.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RAtom,expr__14561)))){
return "ra";
} else {
if(cljs.core.truth_((pred__14560.cljs$core$IFn$_invoke$arity$2 ? pred__14560.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__14561) : pred__14560.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.RCursor,expr__14561)))){
return "rc";
} else {
if(cljs.core.truth_((pred__14560.cljs$core$IFn$_invoke$arity$2 ? pred__14560.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__14561) : pred__14560.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Reaction,expr__14561)))){
return "rx";
} else {
if(cljs.core.truth_((pred__14560.cljs$core$IFn$_invoke$arity$2 ? pred__14560.cljs$core$IFn$_invoke$arity$2(day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__14561) : pred__14560.call(null,day8.re_frame_10x.inlined_deps.reagent.v1v0v0.reagent.ratom.Track,expr__14561)))){
return "tr";
} else {
return "other";
}
