...
var len__4864__auto___16440 = arguments.length;
var i__4865__auto___16441 = (0);
while(true){
if((i__4865__auto___16441 < len__4864__auto___16440)){
args__4870__auto__.push((arguments[i__4865__auto___16441]));

var G__16442 = (i__4865__auto___16441 + (1));
i__4865__auto___16441 = G__16442;
continue;
} else {
}
break;
...
return day8.re_frame_10x.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic(argseq__4871__auto__);
});

(day8.re_frame_10x.view.settings.closeable_text_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__16373){
var map__16374 = p__16373;
var map__16374__$1 = cljs.core.__destructure_map(map__16374);
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16374__$1,new cljs.core.Keyword(null,"model","model",331153215));
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16374__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16374__$1,new cljs.core.Keyword(null,"on-close","on-close",-761178394));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16374__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
...
/** @this {Function} */
(day8.re_frame_10x.view.settings.closeable_text_box.cljs$lang$applyTo = (function (seq16372){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16372));
}));
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.settings_box,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.checkbox,new cljs.core.Keyword(null,"model","model",331153215),follows_events_QMARK_,new cljs.core.Keyword(null,"label","label",1718410804),"sync app-db with epoch navigation",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__16381_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","app-db-follows-events?","settings/app-db-follows-events?",-115495889),p1__16381_SHARP_], null));
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__4652__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__16390(s__16391){
return (new cljs.core.LazySeq(null,(function (){
var s__16391__$1 = s__16391;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__16391__$1);
if(temp__5753__auto__){
var s__16391__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__16391__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__16391__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__16393 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__16392 = (0);
while(true){
if((i__16392 < size__4651__auto__)){
var item = cljs.core._nth(c__4650__auto__,i__16392);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append(b__16393,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__16392,id,item,c__4650__auto__,size__4651__auto__,b__16393,s__16391__$2,temp__5753__auto__){
return (function (){
...
});})(i__16392,id,item,c__4650__auto__,size__4651__auto__,b__16393,s__16391__$2,temp__5753__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__16392,id,item,c__4650__auto__,size__4651__auto__,b__16393,s__16391__$2,temp__5753__auto__){
return (function (p1__16383_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__16383_SHARP_], null));
});})(i__16392,id,item,c__4650__auto__,size__4651__auto__,b__16393,s__16391__$2,temp__5753__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__16443 = (i__16392 + (1));
i__16392 = G__16443;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16393),day8$re_frame_10x$view$settings$render_$_iter__16390(cljs.core.chunk_rest(s__16391__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16393),null);
}
} else {
var item = cljs.core.first(s__16391__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"event-str","event-str",381347778).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"212px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__16391__$2,temp__5753__auto__){
return (function (){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-ignored-event","settings/remove-ignored-event",-391073521),id], null));
});})(id,item,s__16391__$2,temp__5753__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__16391__$2,temp__5753__auto__){
return (function (p1__16383_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-ignored-event","settings/update-ignored-event",-407164743),id,p1__16383_SHARP_], null));
});})(id,item,s__16391__$2,temp__5753__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__16390(cljs.core.rest(s__16391__$2)));
}
} else {
return null;
}
...
})], null)], null)], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.v_box,new cljs.core.Keyword(null,"width","width",-384071477),day8.re_frame_10x.view.settings.comp_section_width,new cljs.core.Keyword(null,"gap","gap",80255254),day8.re_frame_10x.view.settings.vertical_gap,new cljs.core.Keyword(null,"children","children",-940561982),(function (){var iter__4652__auto__ = (function day8$re_frame_10x$view$settings$render_$_iter__16436(s__16437){
return (new cljs.core.LazySeq(null,(function (){
var s__16437__$1 = s__16437;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__16437__$1);
if(temp__5753__auto__){
var s__16437__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__16437__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__16437__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__16439 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__16438 = (0);
while(true){
if((i__16438 < size__4651__auto__)){
var item = cljs.core._nth(c__4650__auto__,i__16438);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
cljs.core.chunk_append(b__16439,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (i__16438,id,item,c__4650__auto__,size__4651__auto__,b__16439,s__16437__$2,temp__5753__auto__){
return (function (){
...
});})(i__16438,id,item,c__4650__auto__,size__4651__auto__,b__16439,s__16437__$2,temp__5753__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__16438,id,item,c__4650__auto__,size__4651__auto__,b__16439,s__16437__$2,temp__5753__auto__){
return (function (p1__16384_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__16384_SHARP_], null));
});})(i__16438,id,item,c__4650__auto__,size__4651__auto__,b__16439,s__16437__$2,temp__5753__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)));

var G__16444 = (i__16438 + (1));
i__16438 = G__16444;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__16439),day8$re_frame_10x$view$settings$render_$_iter__16436(cljs.core.chunk_rest(s__16437__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__16439),null);
}
} else {
var item = cljs.core.first(s__16437__$2);
var id = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(item);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.closeable_text_box,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"ns-str","ns-str",-2062616499).cljs$core$IFn$_invoke$arity$1(item),new cljs.core.Keyword(null,"width","width",-384071477),"343px",new cljs.core.Keyword(null,"on-close","on-close",-761178394),((function (id,item,s__16437__$2,temp__5753__auto__){
return (function (){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","remove-filtered-view-trace","settings/remove-filtered-view-trace",970685301),id], null));
});})(id,item,s__16437__$2,temp__5753__auto__))
,new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (id,item,s__16437__$2,temp__5753__auto__){
return (function (p1__16384_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","update-filtered-view-trace","settings/update-filtered-view-trace",-530575796),id,p1__16384_SHARP_], null));
});})(id,item,s__16437__$2,temp__5753__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null)),day8$re_frame_10x$view$settings$render_$_iter__16436(cljs.core.rest(s__16437__$2)));
}
} else {
return null;
}
...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.view.settings.settings_box,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.label,new cljs.core.Keyword(null,"label","label",1718410804),"Remove low level trace"], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.checkbox,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"reagent","reagent",2131627322).cljs$core$IFn$_invoke$arity$1(low_level_trace),new cljs.core.Keyword(null,"label","label",1718410804),"reagent internals",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__16385_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"reagent","reagent",2131627322),p1__16385_SHARP_], null));
})], null),new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.utils.re_com.checkbox,new cljs.core.Keyword(null,"model","model",331153215),new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033).cljs$core$IFn$_invoke$arity$1(low_level_trace),new cljs.core.Keyword(null,"label","label",1718410804),"re-frame internals",new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__16386_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("settings","low-level-trace","settings/low-level-trace",191054289),new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033),p1__16386_SHARP_], null));
