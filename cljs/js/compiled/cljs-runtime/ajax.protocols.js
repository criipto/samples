...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_21256 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_21256(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_21257 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_21257(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_21258 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_21258(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_21259 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_21259(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_21260 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_21260(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_21261 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_21261(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_21262 = (function (this$,header){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_21262(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_21263 = (function (this$){
var x__4550__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_21263(this$);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k21242,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__21246 = k21242;
var G__21246__$1 = (((G__21246 instanceof cljs.core.Keyword))?G__21246.fqn:null);
switch (G__21246__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21242,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__21247){
var vec__21248 = p__21247;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21248,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21248,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21241){
var self__ = this;
var G__21241__$1 = this;
return (new cljs.core.RecordIter((0),G__21241__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this21243,other21244){
var self__ = this;
var this21243__$1 = this;
return (((!((other21244 == null)))) && ((((this21243__$1.constructor === other21244.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21243__$1.status,other21244.status)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21243__$1.body,other21244.body)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21243__$1.status_text,other21244.status_text)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21243__$1.headers,other21244.headers)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21243__$1.was_aborted,other21244.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21243__$1.__extmap,other21244.__extmap)))))))))))))));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k21242){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k21242);

}
}));

(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__21241){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__21252 = cljs.core.keyword_identical_QMARK_;
var expr__21253 = k__4511__auto__;
if(cljs.core.truth_((pred__21252.cljs$core$IFn$_invoke$arity$2 ? pred__21252.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__21253) : pred__21252.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__21253)))){
return (new ajax.protocols.Response(G__21241,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__21252.cljs$core$IFn$_invoke$arity$2 ? pred__21252.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__21253) : pred__21252.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__21253)))){
return (new ajax.protocols.Response(self__.status,G__21241,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__21252.cljs$core$IFn$_invoke$arity$2 ? pred__21252.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__21253) : pred__21252.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__21253)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__21241,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__21252.cljs$core$IFn$_invoke$arity$2 ? pred__21252.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__21253) : pred__21252.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__21253)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__21241,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__21252.cljs$core$IFn$_invoke$arity$2 ? pred__21252.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__21253) : pred__21252.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__21253)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__21241,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__21241),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__21241){
var self__ = this;
var this__4501__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__21241,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__21245){
var extmap__4542__auto__ = (function (){var G__21255 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__21245,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__21245)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__21255);
} else {
return G__21255;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__21245),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__21245),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__21245),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__21245),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__21245),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
