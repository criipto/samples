 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__12904,right){
var map__12905 = p__12904;
var map__12905__$1 = cljs.core.__destructure_map(map__12905);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12905__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12905__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__12907 = temp__5753__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12907,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12907,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12907,(2),null);
...
while (G__13028__i < G__13028__a.length) {G__13028__a[G__13028__i] = arguments[G__13028__i + 2]; ++G__13028__i;}
  more = new cljs.core.IndexedSeq(G__13028__a,0,null);
} 
...
var more = cljs.core.rest(arglist__13029);
...
var G__13030 = null;
if (arguments.length > 2) {
var G__13031__i = 0, G__13031__a = new Array(arguments.length -  2);
while (G__13031__i < G__13031__a.length) {G__13031__a[G__13031__i] = arguments[G__13031__i + 2]; ++G__13031__i;}
G__13030 = new cljs.core.IndexedSeq(G__13031__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13030);
}
...
var G__13032__delegate = function (x,y,more){
...
while (G__13033__i < G__13033__a.length) {G__13033__a[G__13033__i] = arguments[G__13033__i + 2]; ++G__13033__i;}
  more = new cljs.core.IndexedSeq(G__13033__a,0,null);
} 
...
G__13035 = new cljs.core.IndexedSeq(G__13036__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13035);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
while (G__13038__i < G__13038__a.length) {G__13038__a[G__13038__i] = arguments[G__13038__i + 2]; ++G__13038__i;}
  more = new cljs.core.IndexedSeq(G__13038__a,0,null);
} 
...
G__13040 = new cljs.core.IndexedSeq(G__13041__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13040);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
while (G__13048__i < G__13048__a.length) {G__13048__a[G__13048__i] = arguments[G__13048__i + 2]; ++G__13048__i;}
  more = new cljs.core.IndexedSeq(G__13048__a,0,null);
} 
return G__13046__delegate.call(this,x,y,more);};
G__13046.cljs$lang$maxFixedArity = 2;
G__13046.cljs$lang$applyTo = (function (arglist__13049){
...
G__13050 = new cljs.core.IndexedSeq(G__13051__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13050);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
