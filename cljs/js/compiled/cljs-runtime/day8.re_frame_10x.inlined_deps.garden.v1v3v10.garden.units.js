 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__12915,right){
var map__12916 = p__12915;
var map__12916__$1 = cljs.core.__destructure_map(map__12916);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12916__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12916__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__12917 = temp__5753__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12917,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12917,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12917,(2),null);
...
var G__13066__delegate = function (x,y,more){
...
var G__13066 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
var G__13067__i = 0, G__13067__a = new Array(arguments.length -  2);
while (G__13067__i < G__13067__a.length) {G__13067__a[G__13067__i] = arguments[G__13067__i + 2]; ++G__13067__i;}
  more = new cljs.core.IndexedSeq(G__13067__a,0,null);
} 
return G__13066__delegate.call(this,x,y,more);};
...
return G__13066__delegate(x,y,more);
});
...
G__13069 = new cljs.core.IndexedSeq(G__13070__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13069);
}
...
var G__13072__delegate = function (x,y,more){
...
while (G__13073__i < G__13073__a.length) {G__13073__a[G__13073__i] = arguments[G__13073__i + 2]; ++G__13073__i;}
  more = new cljs.core.IndexedSeq(G__13073__a,0,null);
} 
return G__13072__delegate.call(this,x,y,more);};
G__13072.cljs$lang$maxFixedArity = 2;
G__13072.cljs$lang$applyTo = (function (arglist__13074){
...
G__13075 = new cljs.core.IndexedSeq(G__13076__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13075);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
while (G__13079__i < G__13079__a.length) {G__13079__a[G__13079__i] = arguments[G__13079__i + 2]; ++G__13079__i;}
  more = new cljs.core.IndexedSeq(G__13079__a,0,null);
} 
...
G__13081 = new cljs.core.IndexedSeq(G__13082__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13081);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
while (G__13085__i < G__13085__a.length) {G__13085__a[G__13085__i] = arguments[G__13085__i + 2]; ++G__13085__i;}
  more = new cljs.core.IndexedSeq(G__13085__a,0,null);
} 
...
G__13087 = new cljs.core.IndexedSeq(G__13088__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13087);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
