 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v10.garden.units.convert = (function day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$convert(p__12919,right){
var map__12920 = p__12919;
var map__12920__$1 = cljs.core.__destructure_map(map__12920);
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12920__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12920__$1,new cljs.core.Keyword(null,"unit","unit",375175175));
...
var vec__12921 = temp__5753__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12921,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12921,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12921,(2),null);
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12924__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__12925 = u(y);
var map__12925__$1 = cljs.core.__destructure_map(map__12925);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12925__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 + m2));
});
...
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13041);
}
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12973__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__12974 = u(y);
var map__12974__$1 = cljs.core.__destructure_map(map__12974);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12974__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((m1 - m2));
});
var day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3 = (function() { 
var G__13044__delegate = function (x,y,more){
...
var G__13044 = function (x,y,var_args){
var more = null;
if (arguments.length > 2) {
...
while (G__13045__i < G__13045__a.length) {G__13045__a[G__13045__i] = arguments[G__13045__i + 2]; ++G__13045__i;}
  more = new cljs.core.IndexedSeq(G__13045__a,0,null);
} 
return G__13044__delegate.call(this,x,y,more);};
G__13044.cljs$lang$maxFixedArity = 2;
...
return G__13044__delegate(x,y,more);
});
...
G__13047 = new cljs.core.IndexedSeq(G__13048__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13047);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__12981 = u(x);
var map__12981__$1 = cljs.core.__destructure_map(map__12981);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12981__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__12982 = u(y);
var map__12982__$1 = cljs.core.__destructure_map(map__12982);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12982__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
...
var G__13049__delegate = function (x,y,more){
...
while (G__13050__i < G__13050__a.length) {G__13050__a[G__13050__i] = arguments[G__13050__i + 2]; ++G__13050__i;}
  more = new cljs.core.IndexedSeq(G__13050__a,0,null);
} 
...
var more = cljs.core.rest(arglist__13051);
...
G__13052 = new cljs.core.IndexedSeq(G__13053__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13052);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__12989 = u(x);
var map__12989__$1 = cljs.core.__destructure_map(map__12989);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12989__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
var map__12990 = u(y);
var map__12990__$1 = cljs.core.__destructure_map(map__12990);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12990__$1,new cljs.core.Keyword(null,"magnitude","magnitude",1924274222));
return u((op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2)));
});
...
while (G__13055__i < G__13055__a.length) {G__13055__a[G__13055__i] = arguments[G__13055__i + 2]; ++G__13055__i;}
  more = new cljs.core.IndexedSeq(G__13055__a,0,null);
} 
...
var G__13057 = null;
if (arguments.length > 2) {
var G__13058__i = 0, G__13058__a = new Array(arguments.length -  2);
while (G__13058__i < G__13058__a.length) {G__13058__a[G__13058__i] = arguments[G__13058__i + 2]; ++G__13058__i;}
G__13057 = new cljs.core.IndexedSeq(G__13058__a,0,null);
}
return day8$re_frame_10x$inlined_deps$garden$v1v3v10$garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__13057);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
