...
var map__8674 = top_item;
var map__8674__$1 = cljs.core.__destructure_map(map__8674);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8674__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8674__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__8674__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e8673){var _e = e8673;
return false;
}});
...
var temp__5753__auto___8692 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___8692)){
var sense_8693 = temp__5753__auto___8692;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_8693)].join(''));
} else {
}
}
} else {
