...
var G__11401 = (i__4865__auto___11390 + (1));
i__4865__auto___11390 = G__11401;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11293){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11294,G__11295,seq11293__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11315_SHARP_){
return (!((cljs.core.meta(p1__11315_SHARP_) == null)));
})))){
...
var map__11316 = opts;
var map__11316__$1 = cljs.core.__destructure_map(map__11316);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11316__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11317){var _e__8638__auto__ = e11317;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e11319){var _e__8638__auto__ = e11319;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__11376 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11377 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11377);

try{var map__11378 = opts;
var map__11378__$1 = cljs.core.__destructure_map(map__11378);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11378__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11376);
}});
...
var temp__5751__auto___11402 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___11402)){
var managed_print_level_11403 = temp__5751__auto___11402;
var _STAR_print_level_STAR__orig_val__11387_11404 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__11388_11405 = managed_print_level_11403;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__11388_11405);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__11386_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__11386_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__11387_11404);
}} else {
job_fn();
}
