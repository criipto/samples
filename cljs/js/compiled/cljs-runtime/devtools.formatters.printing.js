...
var len__4864__auto___11315 = arguments.length;
var i__4865__auto___11316 = (0);
while(true){
if((i__4865__auto___11316 < len__4864__auto___11315)){
args__4870__auto__.push((arguments[i__4865__auto___11316]));

var G__11317 = (i__4865__auto___11316 + (1));
i__4865__auto___11316 = G__11317;
continue;
} else {
}
break;
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11290_SHARP_){
return (!((cljs.core.meta(p1__11290_SHARP_) == null)));
})))){
...
}catch (e11298){var _e__8556__auto__ = e11298;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e11300){var _e__8556__auto__ = e11300;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__11302 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11303 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11303);

try{var map__11304 = opts;
var map__11304__$1 = cljs.core.__destructure_map(map__11304);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11304__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11302);
}});
...
var temp__5751__auto___11333 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___11333)){
var managed_print_level_11334 = temp__5751__auto___11333;
var _STAR_print_level_STAR__orig_val__11313_11335 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__11314_11336 = managed_print_level_11334;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__11314_11336);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__11312_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__11312_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__11313_11335);
}} else {
job_fn();
}
