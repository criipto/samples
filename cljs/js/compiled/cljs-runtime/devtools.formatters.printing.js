...
var len__4864__auto___11317 = arguments.length;
var i__4865__auto___11318 = (0);
while(true){
if((i__4865__auto___11318 < len__4864__auto___11317)){
args__4870__auto__.push((arguments[i__4865__auto___11318]));

var G__11319 = (i__4865__auto___11318 + (1));
i__4865__auto___11318 = G__11319;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11281){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11303__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11304){var _e__8838__auto__ = e11304;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e11306){var _e__8838__auto__ = e11306;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__11308 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11309 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11309);

try{var map__11310 = opts;
var map__11310__$1 = cljs.core.__destructure_map(map__11310);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11310__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11308);
}});
...
var _STAR_print_level_STAR__orig_val__11312_11323 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__11313_11324 = managed_print_level_11322;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__11313_11324);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__11311_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__11311_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__11312_11323);
}} else {
job_fn();
}
