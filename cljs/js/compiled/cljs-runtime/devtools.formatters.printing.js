...
var len__4864__auto___11327 = arguments.length;
var i__4865__auto___11328 = (0);
while(true){
if((i__4865__auto___11328 < len__4864__auto___11327)){
args__4870__auto__.push((arguments[i__4865__auto___11328]));

var G__11329 = (i__4865__auto___11328 + (1));
i__4865__auto___11328 = G__11329;
continue;
} else {
}
break;
...
}catch (e11307){var _e__8933__auto__ = e11307;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e11309){var _e__8933__auto__ = e11309;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__11311 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11312 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11312);

try{var map__11313 = opts;
var map__11313__$1 = cljs.core.__destructure_map(map__11313);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11313__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11311);
}});
...
var temp__5751__auto___11357 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___11357)){
var managed_print_level_11358 = temp__5751__auto___11357;
var _STAR_print_level_STAR__orig_val__11325_11359 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__11326_11360 = managed_print_level_11358;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__11326_11360);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__11324_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__11324_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__11325_11359);
}} else {
job_fn();
}
