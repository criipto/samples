...
var len__4864__auto___11293 = arguments.length;
var i__4865__auto___11294 = (0);
while(true){
if((i__4865__auto___11294 < len__4864__auto___11293)){
args__4870__auto__.push((arguments[i__4865__auto___11294]));

var G__11295 = (i__4865__auto___11294 + (1));
i__4865__auto___11294 = G__11295;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq11270){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11271,G__11272,seq11270__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__11276_SHARP_){
return (!((cljs.core.meta(p1__11276_SHARP_) == null)));
})))){
...
var map__11282 = opts;
var map__11282__$1 = cljs.core.__destructure_map(map__11282);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11282__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e11283){var _e__8638__auto__ = e11283;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e11285){var _e__8638__auto__ = e11285;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__11287 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__11288 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__11288);

try{var map__11289 = opts;
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__11287);
}});
...
var temp__5751__auto___11303 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___11303)){
var managed_print_level_11304 = temp__5751__auto___11303;
var _STAR_print_level_STAR__orig_val__11291_11305 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__11292_11306 = managed_print_level_11304;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__11292_11306);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__11290_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__11290_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__11291_11305);
}} else {
job_fn();
}
