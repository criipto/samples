...
var G__18106 = (function (){var G__18095 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [node], null);
...
var or__4253__auto__ = (function (){var G__18100 = zloc;
var G__18100__$1 = (((G__18100 == null))?null:clojure.zip.node(G__18100));
if((G__18100__$1 == null)){
return null;
} else {
return (rewrite_clj.node.length.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.length.cljs$core$IFn$_invoke$arity$1(G__18100__$1) : rewrite_clj.node.length.call(null,G__18100__$1));
}
})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
var G__18101 = s;
var G__18101__$1 = (((G__18101 == null))?null:rewrite_clj.parser.parse_string_all(G__18101));
if((G__18101__$1 == null)){
return null;
} else {
return rewrite_clj.zip.base.edn(G__18101__$1);
}
});
/**
...
return (rewrite_clj.node.string.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string.cljs$core$IFn$_invoke$arity$1(G__18103__$1) : rewrite_clj.node.string.call(null,G__18103__$1));
}
});
/**
...
var G__18104 = zloc;
var G__18104__$1 = (((G__18104 == null))?null:clojure.zip.root(G__18104));
if((G__18104__$1 == null)){
return null;
} else {
return (rewrite_clj.node.string.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string.cljs$core$IFn$_invoke$arity$1(G__18104__$1) : rewrite_clj.node.string.call(null,G__18104__$1));
}
});
