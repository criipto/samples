...
var G__18103 = (function (){var G__18090 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [node], null);
return (rewrite_clj.node.forms_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.forms_node.cljs$core$IFn$_invoke$arity$1(G__18090) : rewrite_clj.node.forms_node.call(null,G__18090));
})();
node = G__18103;
continue;
}
...
var G__18091 = zloc;
var G__18091__$1 = (((G__18091 == null))?null:clojure.zip.node(G__18091));
if((G__18091__$1 == null)){
return null;
} else {
return (rewrite_clj.node.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.tag.cljs$core$IFn$_invoke$arity$1(G__18091__$1) : rewrite_clj.node.tag.call(null,G__18091__$1));
}
});
/**
...
return (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(G__18092__$1) : rewrite_clj.node.sexpr.call(null,G__18092__$1));
}
});
/**
...
return (rewrite_clj.node.child_sexprs.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.child_sexprs.cljs$core$IFn$_invoke$arity$1(G__18093__$1) : rewrite_clj.node.child_sexprs.call(null,G__18093__$1));
}
});
/**
...
var or__4253__auto__ = (function (){var G__18094 = zloc;
var G__18094__$1 = (((G__18094 == null))?null:clojure.zip.node(G__18094));
if((G__18094__$1 == null)){
return null;
} else {
return (rewrite_clj.node.length.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.length.cljs$core$IFn$_invoke$arity$1(G__18094__$1) : rewrite_clj.node.length.call(null,G__18094__$1));
}
})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
