...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19823__$1)].join('')));
...
var prefix = (function (){var G__19843 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [G__19843,"\u2026/"].join('');
} else {
return G__19843;
}
})();
...
var vec__19858 = day8.re_frame_10x.utils.pretty_print_condensed.edges(coll);
var left = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19858,(0),null);
var right = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19858,(1),null);
...
var or__4253__auto__ = (function (){var G__19865 = form.name;
if((G__19865 == null)){
return null;
} else {
return clojure.string.replace(G__19865,/(^.*\$)(.*)/,"$2");
}
})();
...
var len__4864__auto___19900 = arguments.length;
var i__4865__auto___19901 = (0);
while(true){
if((i__4865__auto___19901 < len__4864__auto___19900)){
args__4870__auto__.push((arguments[i__4865__auto___19901]));

var G__19902 = (i__4865__auto___19901 + (1));
i__4865__auto___19901 = G__19902;
continue;
} else {
}
break;
