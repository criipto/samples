...
var _STAR_current_trace_STAR__orig_val__20455 = re_frame.trace._STAR_current_trace_STAR_;
var _STAR_current_trace_STAR__temp_val__20456 = re_frame.trace.start_trace(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"op-type","op-type",-1636141668),new cljs.core.Keyword("event","do-fx","event/do-fx",1357330452)], null));
(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__temp_val__20456);
...
var fexpr__20457_20539 = re_frame.registrar.get_handler.cljs$core$IFn$_invoke$arity$3(re_frame.fx.kind,new cljs.core.Keyword(null,"db","db",993250759),false);
(fexpr__20457_20539.cljs$core$IFn$_invoke$arity$1 ? fexpr__20457_20539.cljs$core$IFn$_invoke$arity$1(new_db_20538) : fexpr__20457_20539.call(null,new_db_20538));
} else {
}

var seq__20462 = cljs.core.seq(effects_without_db);
var chunk__20463 = null;
var count__20464 = (0);
var i__20465 = (0);
while(true){
if((i__20465 < count__20464)){
var vec__20472 = chunk__20463.cljs$core$IIndexed$_nth$arity$2(null,i__20465);
...
var G__20542 = seq__20462;
var G__20543 = chunk__20463;
var G__20544 = count__20464;
var G__20545 = (i__20465 + (1));
seq__20462 = G__20542;
chunk__20463 = G__20543;
count__20464 = G__20544;
i__20465 = G__20545;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__20462);
if(temp__5753__auto__){
var seq__20462__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__20462__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__20462__$1);
var G__20546 = cljs.core.chunk_rest(seq__20462__$1);
var G__20547 = c__4679__auto__;
var G__20548 = cljs.core.count(c__4679__auto__);
var G__20549 = (0);
seq__20462 = G__20546;
chunk__20463 = G__20547;
count__20464 = G__20548;
i__20465 = G__20549;
continue;
} else {
var vec__20475 = cljs.core.first(seq__20462__$1);
...
var G__20552 = cljs.core.next(seq__20462__$1);
var G__20553 = null;
var G__20554 = (0);
var G__20555 = (0);
seq__20462 = G__20552;
chunk__20463 = G__20553;
count__20464 = G__20554;
i__20465 = G__20555;
continue;
}
} else {
...
}}finally {(re_frame.trace._STAR_current_trace_STAR_ = _STAR_current_trace_STAR__orig_val__20455);
}} else {
...
var fexpr__20478_20560 = re_frame.registrar.get_handler.cljs$core$IFn$_invoke$arity$3(re_frame.fx.kind,new cljs.core.Keyword(null,"db","db",993250759),false);
(fexpr__20478_20560.cljs$core$IFn$_invoke$arity$1 ? fexpr__20478_20560.cljs$core$IFn$_invoke$arity$1(new_db_20559) : fexpr__20478_20560.call(null,new_db_20559));
} else {
}

var seq__20479 = cljs.core.seq(effects_without_db);
var chunk__20480 = null;
var count__20481 = (0);
var i__20482 = (0);
while(true){
if((i__20482 < count__20481)){
var vec__20489 = chunk__20480.cljs$core$IIndexed$_nth$arity$2(null,i__20482);
...
var G__20563 = seq__20479;
var G__20564 = chunk__20480;
var G__20565 = count__20481;
var G__20566 = (i__20482 + (1));
seq__20479 = G__20563;
chunk__20480 = G__20564;
count__20481 = G__20565;
i__20482 = G__20566;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__20479);
if(temp__5753__auto__){
var seq__20479__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__20479__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__20479__$1);
var G__20567 = cljs.core.chunk_rest(seq__20479__$1);
var G__20568 = c__4679__auto__;
var G__20569 = cljs.core.count(c__4679__auto__);
var G__20570 = (0);
seq__20479 = G__20567;
chunk__20480 = G__20568;
count__20481 = G__20569;
i__20482 = G__20570;
continue;
} else {
var vec__20492 = cljs.core.first(seq__20479__$1);
var effect_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20492,(0),null);
var effect_value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20492,(1),null);
...
var G__20573 = cljs.core.next(seq__20479__$1);
var G__20574 = null;
var G__20575 = (0);
var G__20576 = (0);
seq__20479 = G__20573;
chunk__20480 = G__20574;
count__20481 = G__20575;
i__20482 = G__20576;
continue;
}
} else {
...
re_frame.fx.dispatch_later = (function re_frame$fx$dispatch_later(p__20495){
var map__20496 = p__20495;
var map__20496__$1 = cljs.core.__destructure_map(map__20496);
var effect = map__20496__$1;
var ms = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20496__$1,new cljs.core.Keyword(null,"ms","ms",-1152709733));
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20496__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
...
var seq__20497 = cljs.core.seq(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,value));
var chunk__20498 = null;
var count__20499 = (0);
var i__20500 = (0);
while(true){
if((i__20500 < count__20499)){
var effect = chunk__20498.cljs$core$IIndexed$_nth$arity$2(null,i__20500);
re_frame.fx.dispatch_later(effect);


var G__20577 = seq__20497;
var G__20578 = chunk__20498;
var G__20579 = count__20499;
var G__20580 = (i__20500 + (1));
seq__20497 = G__20577;
chunk__20498 = G__20578;
count__20499 = G__20579;
i__20500 = G__20580;
continue;
} else {
var temp__5753__auto__ = cljs.core.seq(seq__20497);
if(temp__5753__auto__){
var seq__20497__$1 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__20497__$1)){
var c__4679__auto__ = cljs.core.chunk_first(seq__20497__$1);
var G__20581 = cljs.core.chunk_rest(seq__20497__$1);
var G__20582 = c__4679__auto__;
var G__20583 = cljs.core.count(c__4679__auto__);
var G__20584 = (0);
seq__20497 = G__20581;
chunk__20498 = G__20582;
count__20499 = G__20583;
i__20500 = G__20584;
continue;
} else {
var effect = cljs.core.first(seq__20497__$1);
re_frame.fx.dispatch_later(effect);


var G__20585 = cljs.core.next(seq__20497__$1);
var G__20586 = null;
var G__20587 = (0);
var G__20588 = (0);
seq__20497 = G__20585;
chunk__20498 = G__20586;
count__20499 = G__20587;
i__20500 = G__20588;
continue;
}
} else {
