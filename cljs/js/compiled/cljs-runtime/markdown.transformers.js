...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__22354){
var map__22355 = p__22354;
var map__22355__$1 = cljs.core.__destructure_map(map__22355);
var state = map__22355__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22355__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22355__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var G__22411 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq("<sup>"),cljs.core.second(remaining),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.seq("</sup>")], 0)));
var G__22412 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),remaining);
buf = G__22411;
remaining = G__22412;
continue;
} else {
var G__22413 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(buf,cljs.core.first(remaining));
var G__22414 = cljs.core.rest(remaining);
buf = G__22413;
remaining = G__22414;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__22356){
var map__22357 = p__22356;
var map__22357__$1 = cljs.core.__destructure_map(map__22357);
var state = map__22357__$1;
var buf = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22357__$1,new cljs.core.Keyword(null,"buf","buf",-213913340));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22357__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22357__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22357__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22357__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
...
markdown.transformers.br = (function markdown$transformers$br(text,p__22358){
var map__22359 = p__22358;
var map__22359__$1 = cljs.core.__destructure_map(map__22359);
var state = map__22359__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22359__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22359__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
markdown.transformers.autourl_transformer = (function markdown$transformers$autourl_transformer(text,p__22361){
var map__22362 = p__22361;
var map__22362__$1 = cljs.core.__destructure_map(map__22362);
var state = map__22362__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22362__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var frozen_strings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22362__$1,new cljs.core.Keyword(null,"frozen-strings","frozen-strings",-1410661560));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [clojure.string.replace(text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__22360_SHARP_){
var vec__22363 = markdown.common.freeze_string.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__22360_SHARP_,(1),(cljs.core.count(p1__22360_SHARP_) - (1))),cljs.core.deref(currently_frozen)], 0));
var url = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22363,(0),null);
var frozen_strings__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22363,(1),null);
...
return ["0",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__22367)].join('');
} else {
return G__22367;
}
});
...
})())?text:clojure.string.replace(text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__22366_SHARP_){
var encoded = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.map.cljs$core$IFn$_invoke$arity$2(encoder,cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__22366_SHARP_,(1),(cljs.core.count(p1__22366_SHARP_) - (1)))));
...
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__22368){
var map__22369 = p__22368;
var map__22369__$1 = cljs.core.__destructure_map(map__22369);
var state = map__22369__$1;
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22369__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__22370){
var map__22371 = p__22370;
var map__22371__$1 = cljs.core.__destructure_map(map__22371);
var state = map__22371__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22371__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22371__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22371__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22371__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22371__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22371__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22371__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22371__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22371__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22371__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__22372){
var map__22373 = p__22372;
var map__22373__$1 = cljs.core.__destructure_map(map__22373);
var state = map__22373__$1;
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22373__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22373__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__4251__auto__ = paragraph;
if(cljs.core.truth_(and__4251__auto__)){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__22374 = next_line;
if((G__22374 == null)){
return null;
} else {
return clojure.string.trim(G__22374);
}
})()));
} else {
return and__4251__auto__;
...
markdown.transformers.code = (function markdown$transformers$code(text,p__22375){
var map__22376 = p__22375;
var map__22376__$1 = cljs.core.__destructure_map(map__22376);
var state = map__22376__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22376__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22376__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22376__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22376__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__22377){
var map__22378 = p__22377;
var map__22378__$1 = cljs.core.__destructure_map(map__22378);
var state = map__22378__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22378__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22378__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22378__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22378__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22378__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
var next_line_closes_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last((3),(function (){var G__22379 = next_line;
if((G__22379 == null)){
return null;
} else {
return clojure.string.trim(G__22379);
}
})()));
...
var vec__22380 = cljs.core.split_with(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.not_EQ_,"\n"),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((3),trimmed));
var lang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22380,(0),null);
var code = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22380,(1),null);
 ...
 */
markdown.transformers.blockquote_1 = (function markdown$transformers$blockquote_1(text,p__22383){
var map__22384 = p__22383;
var map__22384__$1 = cljs.core.__destructure_map(map__22384);
var state = map__22384__$1;
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22384__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22384__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22384__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22384__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim(text);
if(cljs.core.truth_((function (){var or__4253__auto__ = code;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
 ...
 */
markdown.transformers.blockquote_2 = (function markdown$transformers$blockquote_2(text,p__22385){
var map__22386 = p__22385;
var map__22386__$1 = cljs.core.__destructure_map(map__22386);
var state = map__22386__$1;
var blockquote_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22386__$1,new cljs.core.Keyword(null,"blockquote-start","blockquote-start",276074935));
var blockquote_end = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22386__$1,new cljs.core.Keyword(null,"blockquote-end","blockquote-end",1122544964));
var blockquote_paragraph = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22386__$1,new cljs.core.Keyword(null,"blockquote-paragraph","blockquote-paragraph",1931783682));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22386__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return ["<ol class='footnotes'>",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__22387_SHARP_),"</ol>"].join('');
})(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (footnotes__$1,p__22388){
var vec__22389 = p__22388;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22389,(0),null);
var label = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22389,(1),null);
...
var vec__22392 = cljs.core.re_matches(/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22392,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22392,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22392,(2),null);
var vec__22395 = cljs.core.re_matches(/^    (.*)$/,line);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22395,(0),null);
var next_val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22395,(1),null);
...
var vec__22401 = ((cljs.core.sequential_QMARK_(data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22401,(0),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22401,(1),null);
...
var G__22431 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([acc,cljs.core.PersistentArrayMap.createAsIfByAssoc([key,new_val])], 0));
var G__22432 = cljs.core.rest(remain);
var G__22433 = key;
acc = G__22431;
remain = G__22432;
prev_key = G__22433;
