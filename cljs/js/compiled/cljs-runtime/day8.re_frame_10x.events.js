...
var G__21019_21232 = cljs.core.deref(window_position_interval);
if((G__21019_21232 == null)){
} else {
clearInterval(G__21019_21232);
}
 ...
 */
day8.re_frame_10x.events.open_debugger_window = (function day8$re_frame_10x$events$open_debugger_window(p__21020){
var map__21021 = p__21020;
var map__21021__$1 = cljs.core.__destructure_map(map__21021);
var dimensions = map__21021__$1;
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21021__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21021__$1,new cljs.core.Keyword(null,"height","height",1025178622));
...
var new_dim = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21027,(1),null);
return new_dim;
}));
...
}))], null),(function (dim,p__21039){
var vec__21042 = p__21039;
...
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21045__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21045__$1,new cljs.core.Keyword(null,"height","height",1025178622));
...
}))], null),(function (_,p__21095){
var vec__21096 = p__21095;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21096,(0),null);
var show_epoch_traces_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21096,(1),null);
return show_epoch_traces_QMARK_;
}));
day8.re_frame_10x.events.app_db_path_mw = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"paths","paths",-1807389588)], null)], 0)),day8.re_frame_10x.events.fixed_after((function (p1__21099_SHARP_){
return day8.re_frame_10x.utils.localstorage.save_BANG_("app-db-paths",p1__21099_SHARP_);
}))], null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","update-path","app-db/update-path",-2057697283),day8.re_frame_10x.events.app_db_path_mw,(function (paths,p__21100){
var vec__21103 = p__21100;
...
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21103,(2),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","update-path-blur","app-db/update-path-blur",637142516),day8.re_frame_10x.events.app_db_path_mw,(function (paths,p__21108){
var vec__21109 = p__21108;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21109,(0),null);
var path_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21109,(1),null);
var map__21112 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(paths,path_id);
var map__21112__$1 = cljs.core.__destructure_map(map__21112);
var valid_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21112__$1,new cljs.core.Keyword(null,"valid-path?","valid-path?",-244388226));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21112__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","set-path-visibility","app-db/set-path-visibility",1482573598),day8.re_frame_10x.events.app_db_path_mw,(function (paths,p__21113){
var vec__21114 = p__21113;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21114,(0),null);
var path_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21114,(1),null);
var open_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21114,(2),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","set-diff-visibility","app-db/set-diff-visibility",709297655),day8.re_frame_10x.events.app_db_path_mw,(function (paths,p__21119){
var vec__21122 = p__21119;
...
var diff_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21122,(2),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","remove-path","app-db/remove-path",-1233894231),day8.re_frame_10x.events.app_db_path_mw,(function (paths,p__21129){
var vec__21130 = p__21129;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21130,(0),null);
var path_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21130,(1),null);
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(paths,path_id);
}));
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","paths","app-db/paths",-1600032730),day8.re_frame_10x.events.app_db_path_mw,(function (db,p__21133){
var vec__21134 = p__21133;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21134,(0),null);
var paths = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21134,(1),null);
return paths;
}));
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("app-db","search-string","app-db/search-string",939397656),(function (db,p__21139){
var vec__21140 = p__21139;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21140,(0),null);
var search_string = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21140,(1),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","set-json-ml-paths","app-db/set-json-ml-paths",582043654),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"json-ml-expansions","json-ml-expansions",1112306261)], null)], 0))], null),(function (db,p__21143){
var vec__21144 = p__21143;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21144,(0),null);
var paths = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21144,(1),null);
day8.re_frame_10x.utils.localstorage.save_BANG_("app-db-json-ml-expansions",paths);

return paths;
}));
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"json-ml-expansions","json-ml-expansions",1112306261)], null)], 0))], null),(function (paths,p__21147){
var vec__21148 = p__21147;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21148,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21148,(1),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("snapshot","reset-current-epoch-app-db","snapshot/reset-current-epoch-app-db",866213056),(function (db,p__21151){
var vec__21152 = p__21151;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21152,(0),null);
var new_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21152,(1),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("epochs","receive-new-traces","epochs/receive-new-traces",-1949348546),(function (p__21156,p__21157){
var map__21158 = p__21156;
var map__21158__$1 = cljs.core.__destructure_map(map__21158);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21158__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__21159 = p__21157;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21159,(0),null);
var new_traces = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21159,(1),null);
...
var map__21166 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(db,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"settings","settings",1556144875),new cljs.core.Keyword(null,"low-level-trace","low-level-trace",638447092)], null));
var map__21166__$1 = cljs.core.__destructure_map(map__21166);
var drop_re_frame = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21166__$1,new cljs.core.Keyword(null,"re-frame","re-frame",-1039473033));
var drop_reagent = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21166__$1,new cljs.core.Keyword(null,"reagent","reagent",2131627322));
...
var retained_traces = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$1((function (p1__21155_SHARP_){
return (new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__21155_SHARP_) < first_id_to_retain);
