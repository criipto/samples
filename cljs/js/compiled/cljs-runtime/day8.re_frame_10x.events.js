...
return re_frame.trace.register_trace_cb(new cljs.core.Keyword("day8.re-frame-10x.events","cb","day8.re-frame-10x.events/cb",-1614608881),(function (p1__20898_SHARP_){
return day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("epochs","receive-new-traces","epochs/receive-new-traces",-1949348546),p1__20898_SHARP_], null));
}));
});
/**
 ...
 */
day8.re_frame_10x.events.dissoc_in = (function day8$re_frame_10x$events$dissoc_in(m,p__20903){
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("settings","window-width","settings/window-width",640332180),(function (db,p__20922){
var vec__20923 = p__20922;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20923,(0),null);
var width = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20923,(1),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("settings","selected-tab","settings/selected-tab",-124010089),(function (db,p__20926){
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("settings","show-panel?","settings/show-panel?",-194286945),(function (db,p__20935){
var vec__20940 = p__20935;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20940,(0),null);
var show_panel_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20940,(1),null);
...
}))], null),(function (_,p__21073){
var vec__21074 = p__21073;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21074,(0),null);
var show_epoch_traces_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21074,(1),null);
return show_epoch_traces_QMARK_;
}));
day8.re_frame_10x.events.app_db_path_mw = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"paths","paths",-1807389588)], null)], 0)),day8.re_frame_10x.events.fixed_after((function (p1__21077_SHARP_){
return day8.re_frame_10x.utils.localstorage.save_BANG_("app-db-paths",p1__21077_SHARP_);
}))], null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","update-path","app-db/update-path",-2057697283),day8.re_frame_10x.events.app_db_path_mw,(function (paths,p__21078){
var vec__21079 = p__21078;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21079,(0),null);
var path_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21079,(1),null);
var path_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21079,(2),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","update-path-blur","app-db/update-path-blur",637142516),day8.re_frame_10x.events.app_db_path_mw,(function (paths,p__21082){
var vec__21083 = p__21082;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21083,(0),null);
var path_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21083,(1),null);
var map__21087 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(paths,path_id);
var map__21087__$1 = cljs.core.__destructure_map(map__21087);
var valid_path_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21087__$1,new cljs.core.Keyword(null,"valid-path?","valid-path?",-244388226));
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21087__$1,new cljs.core.Keyword(null,"path","path",-188191168));
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","set-path-visibility","app-db/set-path-visibility",1482573598),day8.re_frame_10x.events.app_db_path_mw,(function (paths,p__21090){
var vec__21091 = p__21090;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21091,(0),null);
var path_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21091,(1),null);
var open_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21091,(2),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","set-diff-visibility","app-db/set-diff-visibility",709297655),day8.re_frame_10x.events.app_db_path_mw,(function (paths,p__21094){
var vec__21095 = p__21094;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21095,(0),null);
var path_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21095,(1),null);
var diff_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21095,(2),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","remove-path","app-db/remove-path",-1233894231),day8.re_frame_10x.events.app_db_path_mw,(function (paths,p__21098){
var vec__21099 = p__21098;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21099,(0),null);
var path_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21099,(1),null);
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(paths,path_id);
}));
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","paths","app-db/paths",-1600032730),day8.re_frame_10x.events.app_db_path_mw,(function (db,p__21104){
var vec__21105 = p__21104;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21105,(0),null);
var paths = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21105,(1),null);
return paths;
}));
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("app-db","search-string","app-db/search-string",939397656),(function (db,p__21112){
var vec__21113 = p__21112;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21113,(0),null);
var search_string = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21113,(1),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","set-json-ml-paths","app-db/set-json-ml-paths",582043654),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"json-ml-expansions","json-ml-expansions",1112306261)], null)], 0))], null),(function (db,p__21119){
var vec__21120 = p__21119;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21120,(0),null);
var paths = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21120,(1),null);
day8.re_frame_10x.utils.localstorage.save_BANG_("app-db-json-ml-expansions",paths);

return paths;
}));
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("app-db","toggle-expansion","app-db/toggle-expansion",-1617765538),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"app-db","app-db",865606302),new cljs.core.Keyword(null,"json-ml-expansions","json-ml-expansions",1112306261)], null)], 0))], null),(function (paths,p__21123){
var vec__21124 = p__21123;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21124,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21124,(1),null);
...
day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$3(new cljs.core.Keyword("epochs","previous-epoch","epochs/previous-epoch",480286026),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [day8.re_frame_10x.inlined_deps.re_frame.v1v1v2.re_frame.core.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"epochs","epochs",1796936425)], null)], 0))], null),(function (p__21153,_){
var map__21154 = p__21153;
var map__21154__$1 = cljs.core.__destructure_map(map__21154);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21154__$1,new cljs.core.Keyword(null,"db","db",993250759));
