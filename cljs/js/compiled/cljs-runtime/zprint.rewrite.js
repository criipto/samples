...
var G__18438 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__18438;
continue;
} else {
var G__18439 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__18439;
continue;
}
} else {
var G__18440 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__18440;
continue;
}
}
...
var G__18405 = zloc;
var G__18406 = (function (){var G__18407 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__18408 = zloc;
var G__18408__$1 = (((G__18408 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__18408) : rewrite_clj.zip.node.call(null,G__18408)));
if((G__18408__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__18408__$1) : zprint.zutil.edn_STAR_.call(null,G__18408__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__18407) : rewrite_clj.zip.root.call(null,G__18407));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__18405,G__18406) : rewrite_clj.zip.replace.call(null,G__18405,G__18406));
});
/**
...
var G__18449 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__18449;
continue;
}
break;
...
var G__18450 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__18451 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__18450;
out = G__18451;
continue;
} else {
...
var G__18458 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__18459 = cljs.core.next(new_loc);
var G__18460 = replaced_loc;
nloc = G__18458;
new_loc = G__18459;
last_loc = G__18460;
continue;
...
return zprint.rewrite.sort_val((function (){var G__18426 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__18426) : rewrite_clj.zip.down.call(null,G__18426));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__18427_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__18427_SHARP_) : rewrite_clj.zip.tag.call(null,p1__18427_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__18427_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__18427_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
