...
var len__4864__auto___18164 = arguments.length;
var i__4865__auto___18165 = (0);
while(true){
if((i__4865__auto___18165 < len__4864__auto___18164)){
args__4870__auto__.push((arguments[i__4865__auto___18165]));

var G__18166 = (i__4865__auto___18165 + (1));
i__4865__auto___18165 = G__18166;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__18115){
var vec__18116 = p__18115;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18116,(0),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__18112_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq18113){
var G__18114 = cljs.core.first(seq18113);
var seq18113__$1 = cljs.core.next(seq18113);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18114,seq18113__$1);
}));

rewrite_clj.zip.findz.in_range_QMARK_ = (function rewrite_clj$zip$findz$in_range_QMARK_(p__18119,p__18120){
var map__18121 = p__18119;
var map__18121__$1 = cljs.core.__destructure_map(map__18121);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18121__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18121__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var end_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18121__$1,new cljs.core.Keyword(null,"end-row","end-row",-545103581));
var end_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18121__$1,new cljs.core.Keyword(null,"end-col","end-col",-724155879));
var map__18122 = p__18120;
var map__18122__$1 = cljs.core.__destructure_map(map__18122);
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18122__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var c = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18122__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__18125_SHARP_){
var and__4251__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__18125_SHARP_) : p_QMARK_.call(null,p1__18125_SHARP_));
if(cljs.core.truth_(and__4251__auto__)){
return rewrite_clj.zip.findz.in_range_QMARK_(cljs.core.meta(clojure.zip.node(p1__18125_SHARP_)),pos);
} else {
return and__4251__auto__;
}
...
var G__18130 = zloc;
var G__18130__$1 = (((G__18130 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__18130) : f.call(null,G__18130)));
if((G__18130__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__18130__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__18131_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__18131_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__18136_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__18136_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__18141_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__18141_SHARP_),v);
}));
