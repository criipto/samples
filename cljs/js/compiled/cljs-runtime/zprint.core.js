...
var vec__19656 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__19659 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19659,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19659,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19656,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19656,(1),null);
...
var G__19788 = cljs.core.next(style_vec);
var G__19789 = ends_w_blanks_QMARK_;
var G__19790 = tuple;
var G__19791 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__19788;
previous_ends_w_blanks_QMARK_ = G__19789;
previous_tuple = G__19790;
out = G__19791;
continue;
}
break;
...
var G__19794 = (i__4865__auto___19793 + (1));
i__4865__auto___19793 = G__19794;
continue;
} else {
}
break;
...
try{var vec__19749 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19749,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19749,(1),null);
...
var vec__19752 = (cljs.core.truth_((function (){var or__4253__auto__ = range_start__$1;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19752,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19752,(1),null);
...
var vec__19755 = (cljs.core.truth_((function (){var and__4251__auto__ = actual_start;
if(cljs.core.truth_(and__4251__auto__)){
return actual_end;
} else {
return and__4251__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19755,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19755,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19755,(2),null);
...
var forms = (function (){var G__19762 = rewrite_clj.parser.parse_string_all(filestring__$1);
