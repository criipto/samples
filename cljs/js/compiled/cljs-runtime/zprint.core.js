...
var vec__19659 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__19662 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19662,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19662,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19659,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19659,(1),null);
...
var G__19773 = cljs.core.next(style_vec);
var G__19774 = ends_w_blanks_QMARK_;
var G__19775 = tuple;
var G__19776 = (cljs.core.truth_(add_previous_to_out_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,previous_tuple):out);
style_vec = G__19773;
previous_ends_w_blanks_QMARK_ = G__19774;
previous_tuple = G__19775;
out = G__19776;
continue;
}
break;
...
var len__4864__auto___19777 = arguments.length;
var i__4865__auto___19778 = (0);
while(true){
if((i__4865__auto___19778 < len__4864__auto___19777)){
args__4870__auto__.push((arguments[i__4865__auto___19778]));

var G__19779 = (i__4865__auto___19778 + (1));
i__4865__auto___19778 = G__19779;
continue;
} else {
}
break;
...
var args__4870__auto__ = [];
var len__4864__auto___19794 = arguments.length;
var i__4865__auto___19795 = (0);
while(true){
if((i__4865__auto___19795 < len__4864__auto___19794)){
args__4870__auto__.push((arguments[i__4865__auto___19795]));

var G__19797 = (i__4865__auto___19795 + (1));
i__4865__auto___19795 = G__19797;
continue;
} else {
}
break;
...
var G__19803 = cljs.core.next(sos);
var G__19804 = comment_QMARK_;
var G__19805 = (function (){var or__4253__auto__ = (!(empty_string_QMARK_));
if(or__4253__auto__){
return or__4253__auto__;
} else {
...
var G__19806 = ((empty_string_QMARK_)?out:((cljs.core.not(start_interpolating_QMARK_))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,s):(cljs.core.truth_(previous_comment_QMARK_)?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,"\n"),s):cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,interpose_str),s)
)));
sos = G__19803;
previous_comment_QMARK_ = G__19804;
start_interpolating_QMARK_ = G__19805;
out = G__19806;
continue;
}
break;
...
try{var vec__19760 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19760,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19760,(1),null);
...
var vec__19763 = (cljs.core.truth_((function (){var or__4253__auto__ = range_start__$1;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19763,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19763,(1),null);
...
var vec__19766 = (cljs.core.truth_((function (){var and__4251__auto__ = actual_start;
if(cljs.core.truth_(and__4251__auto__)){
return actual_end;
} else {
return and__4251__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19766,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19766,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19766,(2),null);
...
var forms = (function (){var G__19769 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__19769) : zprint.zutil.edn_STAR_.call(null,G__19769));
})();
