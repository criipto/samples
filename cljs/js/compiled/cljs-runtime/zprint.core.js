...
var vec__19648 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__19653 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19653,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19653,(1),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19648,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19648,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__19670){
var vec__19671 = p__19670;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19671,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19671,(1),null);
...
var vec__19712 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19712,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19712,(1),null);
...
var result = (function (){var G__19715 = zprint.core.parse_string_all_options(rest_options);
var G__19716 = zprint.core.zprint_str_internal;
var G__19717 = ":parse-string-all? call";
var G__19718 = (function (){var G__19719 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__19719) : zprint.zutil.edn_STAR_.call(null,G__19719));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__19715,G__19716,G__19717,G__19718) : zprint.core.process_multiple_forms.call(null,G__19715,G__19716,G__19717,G__19718));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__19720 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19720,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19720,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq19709){
var G__19710 = cljs.core.first(seq19709);
var seq19709__$1 = cljs.core.next(seq19709);
var G__19711 = cljs.core.first(seq19709__$1);
var seq19709__$2 = cljs.core.next(seq19709__$1);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19710,G__19711,seq19709__$2);
}));
...
var G__19814 = (i__4865__auto___19808 + (1));
i__4865__auto___19808 = G__19814;
continue;
} else {
}
break;
...
var args__4870__auto__ = [];
var len__4864__auto___19815 = arguments.length;
var i__4865__auto___19816 = (0);
while(true){
if((i__4865__auto___19816 < len__4864__auto___19815)){
args__4870__auto__.push((arguments[i__4865__auto___19816]));

var G__19817 = (i__4865__auto___19816 + (1));
i__4865__auto___19816 = G__19817;
continue;
} else {
}
break;
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq19735){
var G__19736 = cljs.core.first(seq19735);
var seq19735__$1 = cljs.core.next(seq19735);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19736,seq19735__$1);
}));
...
try{var vec__19766 = zprint.core.remove_shebang(file_str);
var shebang = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19766,(0),null);
var file_str__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19766,(1),null);
...
var vec__19769 = (cljs.core.truth_((function (){var or__4253__auto__ = range_start__$1;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return range_end__$1;
...
var actual_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19769,(0),null);
var actual_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19769,(1),null);
...
var vec__19772 = (cljs.core.truth_((function (){var and__4251__auto__ = actual_start;
if(cljs.core.truth_(and__4251__auto__)){
return actual_end;
} else {
return and__4251__auto__;
...
var before_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19772,(0),null);
var range = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19772,(1),null);
var after_lines = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19772,(2),null);
...
var forms = (function (){var G__19791 = rewrite_clj.parser.parse_string_all(filestring__$1);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__19791) : zprint.zutil.edn_STAR_.call(null,G__19791));
})();
