...
var vec__19694 = (cljs.core.truth_(new cljs.core.Keyword(null,"zipper?","zipper?",-1061271842).cljs$core$IFn$_invoke$arity$1(options))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [coll,options], null):(cljs.core.truth_(new cljs.core.Keyword(null,"parse-string?","parse-string?",2006674325).cljs$core$IFn$_invoke$arity$1(options))?((typeof coll === 'string')?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [zprint.core.get_zipper(options,coll),options], null):(function(){throw (new Error(["Collection is not a string yet"," :parse-string? specified!"].join('')))})()):(cljs.core.truth_(new cljs.core.Keyword(null,"zloc?","zloc?",-1457193855).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"focus","focus",234677911).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"output","output",-1105869043).cljs$core$IFn$_invoke$arity$1(options))))?(function (){var vec__19697 = zprint.zutil.find_root_and_path_nw(coll);
var root = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19697,(0),null);
...
var input = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19694,(0),null);
var options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19694,(1),null);
 ...
 */
zprint.core.process_rest_options = (function zprint$core$process_rest_options(internal_options,p__19700){
var vec__19701 = p__19700;
var width_or_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19701,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19701,(1),null);
...
var width_or_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19704,(0),null);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19704,(1),null);
...
var vec__19708 = zprint.config.perform_remove(null,null,zprint.config.get_options(),rest_options);
var internal_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19708,(0),null);
var rest_options__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19708,(1),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19708,(2),null);
var vec__19711 = zprint.config.apply_style(null,null,internal_map,rest_options__$1);
var updated_map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19711,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19711,(1),null);
var style_errors = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19711,(2),null);
 ...
 */
zprint.core.range_vec = (function zprint$core$range_vec(v,p__19718){
var vec__19719 = p__19718;
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19719,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19719,(1),null);
...
var vec__19722 = tuple;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19722,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19722,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19722,(2),null);
...
var vec__19730 = cljs.core.first(style_vec);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19730,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19730,(1),null);
var e = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19730,(2),null);
var tuple = vec__19730;
...
var vec__19739 = zprint.core.process_rest_options(internal_options,rest);
var special_option = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19739,(0),null);
var rest_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19739,(1),null);
...
var result = (function (){var G__19744 = zprint.core.parse_string_all_options(rest_options);
var G__19745 = zprint.core.zprint_str_internal;
var G__19746 = ":parse-string-all? call";
var G__19747 = (function (){var G__19749 = rewrite_clj.parser.parse_string_all(coll);
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__19749) : zprint.zutil.edn_STAR_.call(null,G__19749));
})();
return (zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4 ? zprint.core.process_multiple_forms.cljs$core$IFn$_invoke$arity$4(G__19744,G__19745,G__19746,G__19747) : zprint.core.process_multiple_forms.call(null,G__19744,G__19745,G__19746,G__19747));
})();
if(cljs.core.truth_(new cljs.core.Keyword(null,"dbg?","dbg?",1845730771).cljs$core$IFn$_invoke$arity$1(rest_options))){
...
var vec__19750 = zprint.core.zprint_STAR_(coll,special_option,actual_options);
var cvec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19750,(0),null);
var options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19750,(1),null);
...
/** @this {Function} */
(zprint.core.zprint_str_internal.cljs$lang$applyTo = (function (seq19733){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19734,G__19735,seq19733__$2);
}));
...
/** @this {Function} */
(zprint.core.zprint_str.cljs$lang$applyTo = (function (seq19758){
var G__19759 = cljs.core.first(seq19758);
var seq19758__$1 = cljs.core.next(seq19758);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19759,seq19758__$1);
}));
...
/** @this {Function} */
(zprint.core.zprint.cljs$lang$applyTo = (function (seq19762){
var G__19763 = cljs.core.first(seq19762);
var seq19762__$1 = cljs.core.next(seq19762);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19763,seq19762__$1);
}));
...
/** @this {Function} */
(zprint.core.czprint.cljs$lang$applyTo = (function (seq19764){
var G__19765 = cljs.core.first(seq19764);
var seq19764__$1 = cljs.core.next(seq19764);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__19765,seq19764__$1);
}));
 ...
 */
zprint.core.process_form = (function zprint$core$process_form(rest_options,zprint_fn,zprint_specifier,p__19774,form){
var vec__19775 = p__19774;
var next_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19775,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19775,(1),null);
var indent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19775,(2),null);
var zprint_num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19775,(3),null);
var comment_QMARK_ = zprint.zutil.zcomment_QMARK_(form);
var whitespace_form_QMARK_ = zprint.zutil.whitespace_QMARK_(form);
var vec__19778 = (cljs.core.truth_((function (){var and__4251__auto__ = comment_QMARK_;
if(cljs.core.truth_(and__4251__auto__)){
...
var new_options = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19778,(0),null);
var error_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19778,(1),null);
