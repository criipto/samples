...
return [(function (){var pred__20015 = cljs.core.instance_QMARK_;
var expr__20016 = reactive_val;
if(cljs.core.truth_((pred__20015.cljs$core$IFn$_invoke$arity$2 ? pred__20015.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__20016) : pred__20015.call(null,reagent.ratom.RAtom,expr__20016)))){
return "ra";
} else {
if(cljs.core.truth_((pred__20015.cljs$core$IFn$_invoke$arity$2 ? pred__20015.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__20016) : pred__20015.call(null,reagent.ratom.RCursor,expr__20016)))){
return "rc";
} else {
if(cljs.core.truth_((pred__20015.cljs$core$IFn$_invoke$arity$2 ? pred__20015.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__20016) : pred__20015.call(null,reagent.ratom.Reaction,expr__20016)))){
return "rx";
} else {
if(cljs.core.truth_((pred__20015.cljs$core$IFn$_invoke$arity$2 ? pred__20015.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__20016) : pred__20015.call(null,reagent.ratom.Track,expr__20016)))){
return "tr";
} else {
return "other";
}
