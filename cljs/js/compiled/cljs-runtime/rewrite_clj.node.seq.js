...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k17875,else__4505__auto__){
var self__ = this;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__17881){
var vec__17882 = p__17881;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17882,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17882,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__17874){
var self__ = this;
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this17876,other17877){
var self__ = this;
var this17876__$1 = this;
return (((!((other17877 == null)))) && ((((this17876__$1.constructor === other17877.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17876__$1.tag,other17877.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17876__$1.wrap_fn,other17877.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17876__$1.wrap_length,other17877.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17876__$1.seq_fn,other17877.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17876__$1.children,other17877.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17876__$1.__extmap,other17877.__extmap)))))))))))))));
}));
...
var self__ = this;
var this$__$1 = this;
var G__17894 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__17894) : self__.seq_fn.call(null,G__17894));
}));
...
var self__ = this;
var this$__$1 = this;
var G__17895 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__17895) : self__.wrap_fn.call(null,G__17895));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k17875){
var self__ = this;
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__17874){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__17900 = cljs.core.keyword_identical_QMARK_;
var expr__17901 = k__4511__auto__;
if(cljs.core.truth_((pred__17900.cljs$core$IFn$_invoke$arity$2 ? pred__17900.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__17901) : pred__17900.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__17901)))){
return (new rewrite_clj.node.seq.SeqNode(G__17874,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17900.cljs$core$IFn$_invoke$arity$2 ? pred__17900.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__17901) : pred__17900.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__17901)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__17874,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17900.cljs$core$IFn$_invoke$arity$2 ? pred__17900.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__17901) : pred__17900.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__17901)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__17874,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17900.cljs$core$IFn$_invoke$arity$2 ? pred__17900.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__17901) : pred__17900.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__17901)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__17874,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17900.cljs$core$IFn$_invoke$arity$2 ? pred__17900.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__17901) : pred__17900.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__17901)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__17874,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__17874),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__17874){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__17874,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__17878){
var extmap__4542__auto__ = (function (){var G__17908 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__17878,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__17878),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__17878),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__17878),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__17878),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__17878),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__17909_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__17909_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__17910_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__17910_SHARP_);
}),children);
});
