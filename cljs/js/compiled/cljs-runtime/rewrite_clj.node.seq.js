...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k17849,else__4505__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k17849,else__4505__auto__);
...
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17855,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17855,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__17848){
var self__ = this;
var G__17848__$1 = this;
return (new cljs.core.RecordIter((0),G__17848__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this17850,other17851){
var self__ = this;
var this17850__$1 = this;
return (((!((other17851 == null)))) && ((((this17850__$1.constructor === other17851.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17850__$1.tag,other17851.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17850__$1.wrap_fn,other17851.wrap_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17850__$1.wrap_length,other17851.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17850__$1.seq_fn,other17851.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17850__$1.children,other17851.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17850__$1.__extmap,other17851.__extmap)))))))))))))));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k17849){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k17849);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__17848){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__17867 = cljs.core.keyword_identical_QMARK_;
var expr__17868 = k__4511__auto__;
if(cljs.core.truth_((pred__17867.cljs$core$IFn$_invoke$arity$2 ? pred__17867.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__17868) : pred__17867.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__17868)))){
return (new rewrite_clj.node.seq.SeqNode(G__17848,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17867.cljs$core$IFn$_invoke$arity$2 ? pred__17867.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__17868) : pred__17867.call(null,new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),expr__17868)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__17848,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17867.cljs$core$IFn$_invoke$arity$2 ? pred__17867.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__17868) : pred__17867.call(null,new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__17868)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__17848,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17867.cljs$core$IFn$_invoke$arity$2 ? pred__17867.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__17868) : pred__17867.call(null,new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__17868)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__17848,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17867.cljs$core$IFn$_invoke$arity$2 ? pred__17867.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__17868) : pred__17867.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__17868)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__17848,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__17848),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__17848){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__17848,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__17852){
var extmap__4542__auto__ = (function (){var G__17871 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__17852,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__17852)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__17871);
} else {
return G__17871;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__17852),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__17852),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__17852),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__17852),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__17852),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__17872_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__17872_SHARP_);
}),children);
});
/**
