...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11984 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11984(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11985 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11985(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11986 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11986(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11987 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11987(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11988 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11988(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11989 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11989(reader);
}
});
...
var G__11993 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11994 = s.append(c);
c = G__11993;
s = G__11994;
continue;
}
