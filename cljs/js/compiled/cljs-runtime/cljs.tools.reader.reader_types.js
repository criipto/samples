...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12066 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12066(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12067 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12067(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12068 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12068(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12069 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12069(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12070 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12070(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12071 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12071(reader);
}
});
