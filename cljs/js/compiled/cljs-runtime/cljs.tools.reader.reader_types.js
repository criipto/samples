...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12001 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12001(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12002 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12002(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12003 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12003(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12004 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12004(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12005 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12005(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12006 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12006(reader);
}
});
...
var G__12010 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__12011 = s.append(c);
c = G__12010;
s = G__12011;
continue;
}
