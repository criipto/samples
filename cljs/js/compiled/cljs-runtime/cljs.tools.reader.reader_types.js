...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_12014 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_12014(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_12015 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_12015(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12016 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_12016(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12017 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_12017(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12018 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_12018(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12019 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_12019(reader);
}
});
...
var G__12039 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__12040 = s.append(c);
c = G__12039;
s = G__12040;
continue;
}
