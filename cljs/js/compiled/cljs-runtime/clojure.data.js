...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__8999){
...
var clojure$data$EqualityPartition$equality_partition$dyn_9032 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_9032(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_9039 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_9039(a,b);
}
});
...
var fexpr__9029 = (function (){var G__9030 = clojure.data.equality_partition(a);
var G__9030__$1 = (((G__9030 instanceof cljs.core.Keyword))?G__9030.fqn:null);
switch (G__9030__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9030__$1)].join('')));

}
})();
return (fexpr__9029.cljs$core$IFn$_invoke$arity$2 ? fexpr__9029.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__9029.call(null,a,b));
}));
/**
