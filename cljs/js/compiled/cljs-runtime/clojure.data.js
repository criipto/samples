...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__8974){
...
var vec__8978 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8978,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8978,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8978,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_9013 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_9013(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_9014 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_9014(a,b);
}
});
...
var fexpr__9010 = (function (){var G__9011 = clojure.data.equality_partition(a);
var G__9011__$1 = (((G__9011 instanceof cljs.core.Keyword))?G__9011.fqn:null);
switch (G__9011__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9011__$1)].join('')));

}
})();
return (fexpr__9010.cljs$core$IFn$_invoke$arity$2 ? fexpr__9010.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__9010.call(null,a,b));
}));
/**
