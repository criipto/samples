...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__18134,k,f){
var vec__18135 = p__18134;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18135,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18135,(1),null);
var loc = vec__18135;
...
var G__18176 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__18176;
continue;
}
break;
...
var G__18177 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__18177;
continue;
} else {
return zloc__$1;
...
var G__18178 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__18178;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__18145){
var vec__18146 = p__18145;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18146,(0),null);
var map__18149 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18146,(1),null);
var map__18149__$1 = cljs.core.__destructure_map(map__18149);
var path = map__18149__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18149__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__18146;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__18165){
var vec__18167 = p__18165;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18167,(0),null);
var map__18170 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18167,(1),null);
var map__18170__$1 = cljs.core.__destructure_map(map__18170);
var path = map__18170__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18170__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__18167;
if(cljs.core.seq(r)){
...
var vec__18172 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18172,(0),null);
var map__18175 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18172,(1),null);
var map__18175__$1 = cljs.core.__destructure_map(map__18175);
var path = map__18175__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18175__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18175__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18175__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18175__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
