...
var G__16073 = o;
reagent.impl.template.goog$module$goog$object.set(G__16073,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__16101__delegate = function (args){
...
return G__16101__delegate.call(this,args);};
G__16101.cljs$lang$maxFixedArity = 0;
G__16101.cljs$lang$applyTo = (function (arglist__16103){
var args = cljs.core.seq(arglist__16103);
return G__16101__delegate(args);
});
...
var G__16074 = o;
reagent.impl.template.goog$module$goog$object.set(G__16074,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__16104__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
var G__16075 = props;
var G__16075__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__16075,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__16075);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__16075__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__16076 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__16076,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__16076;
}
})(),id_class);
...
var G__16077 = (cljs.core.count(argv) - first_child);
switch (G__16077) {
case (0):
...
var vec__16078 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16078,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16078,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16078,(2),null);
...
var temp__5757__auto___16108 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___16108 == null)){
} else {
var key_16109 = temp__5757__auto___16108;
(jsprops.key = key_16109);
}
...
var temp__5757__auto___16110 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___16110 == null)){
} else {
var key_16111 = temp__5757__auto___16110;
(jsprops.key = key_16111);
}
...
var temp__5757__auto___16112 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___16112 == null)){
} else {
var key_16113 = temp__5757__auto___16112;
(jsprops.key = key_16113);
}
...
var temp__5757__auto___16132 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___16132 == null)){
} else {
var key_16133 = temp__5757__auto___16132;
(jsprops.key = key_16133);
}
...
var temp__5757__auto___16134 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___16134 == null)){
} else {
var key_16135 = temp__5757__auto___16134;
(jsprops.key = key_16135);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16081_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__16081_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__16082 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16082,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16082,(1),null);
...
break;
default:
var G__16137 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__16138 = compiler;
v = G__16137;
compiler = G__16138;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template16088 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template16088 = (function (opts,id,fn_to_element,parse_fn,meta16089){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template16088.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16090,meta16089__$1){
var self__ = this;
var _16090__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template16088(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta16089__$1));
}));

(reagent.impl.template.t_reagent$impl$template16088.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16090){
var self__ = this;
var _16090__$1 = this;
return self__.meta16089;
}));

(reagent.impl.template.t_reagent$impl$template16088.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template16088.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template16088.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template16088.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template16088.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template16088.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta16089","meta16089",1872486969,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template16088.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template16088.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template16088");

(reagent.impl.template.t_reagent$impl$template16088.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template16088");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template16088.
 */
reagent.impl.template.__GT_t_reagent$impl$template16088 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template16088(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta16089){
return (new reagent.impl.template.t_reagent$impl$template16088(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta16089));
});

}

return (new reagent.impl.template.t_reagent$impl$template16088(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
