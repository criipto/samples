...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4504__auto__,k17652,else__4505__auto__){
var self__ = this;
var this__4504__auto____$1 = this;
var G__17658 = k17652;
var G__17658__$1 = (((G__17658 instanceof cljs.core.Keyword))?G__17658.fqn:null);
switch (G__17658__$1) {
case "k":
return self__.k;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k17652,else__4505__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4525__auto__,p__17663){
var vec__17664 = p__17663;
var k__4526__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17664,(0),null);
var v__4527__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17664,(1),null);
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__17651){
var self__ = this;
var G__17651__$1 = this;
return (new cljs.core.RecordIter((0),G__17651__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"k","k",-2146297393),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this17653,other17654){
var self__ = this;
var this17653__$1 = this;
return (((!((other17654 == null)))) && ((((this17653__$1.constructor === other17654.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17653__$1.k,other17654.k)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17653__$1.namespaced_QMARK_,other17654.namespaced_QMARK_)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this17653__$1.__extmap,other17654.__extmap)))))))));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4509__auto__,k17652){
var self__ = this;
var this__4509__auto____$1 = this;
var G__17674 = k17652;
var G__17674__$1 = (((G__17674 instanceof cljs.core.Keyword))?G__17674.fqn:null);
switch (G__17674__$1) {
case "k":
case "namespaced?":
return true;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k17652);

}
}));

(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4510__auto__,k__4511__auto__,G__17651){
var self__ = this;
var this__4510__auto____$1 = this;
var pred__17675 = cljs.core.keyword_identical_QMARK_;
var expr__17676 = k__4511__auto__;
if(cljs.core.truth_((pred__17675.cljs$core$IFn$_invoke$arity$2 ? pred__17675.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__17676) : pred__17675.call(null,new cljs.core.Keyword(null,"k","k",-2146297393),expr__17676)))){
return (new rewrite_clj.node.keyword.KeywordNode(G__17651,self__.namespaced_QMARK_,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17675.cljs$core$IFn$_invoke$arity$2 ? pred__17675.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__17676) : pred__17675.call(null,new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877),expr__17676)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,G__17651,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4511__auto__,G__17651),null));
}
}
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4501__auto__,G__17651){
var self__ = this;
var this__4501__auto____$1 = this;
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.namespaced_QMARK_,G__17651,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.keyword.map__GT_KeywordNode = (function rewrite_clj$node$keyword$map__GT_KeywordNode(G__17656){
var extmap__4542__auto__ = (function (){var G__17678 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__17656,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877)], 0));
if(cljs.core.record_QMARK_(G__17656)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__17678);
} else {
return G__17678;
}
})();
return (new rewrite_clj.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__17656),new cljs.core.Keyword(null,"namespaced?","namespaced?",-877312877).cljs$core$IFn$_invoke$arity$1(G__17656),null,cljs.core.not_empty(extmap__4542__auto__),null));
});
...
var len__4864__auto___17697 = arguments.length;
var i__4865__auto___17698 = (0);
while(true){
if((i__4865__auto___17698 < len__4864__auto___17697)){
args__4870__auto__.push((arguments[i__4865__auto___17698]));

var G__17699 = (i__4865__auto___17698 + (1));
i__4865__auto___17698 = G__17699;
continue;
} else {
}
break;
...
(rewrite_clj.node.keyword.keyword_node.cljs$core$IFn$_invoke$arity$variadic = (function (k,p__17681){
var vec__17682 = p__17681;
var namespaced_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17682,(0),null);
...
/** @this {Function} */
(rewrite_clj.node.keyword.keyword_node.cljs$lang$applyTo = (function (seq17679){
var G__17680 = cljs.core.first(seq17679);
var seq17679__$1 = cljs.core.next(seq17679);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17680,seq17679__$1);
}));
